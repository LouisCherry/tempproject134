...
/**
 * 项目基本信息表对应的后台service实现类
 *
 * @author Anber
 * @version [版本号, 2022-12-22 21:30:33]
 */
@Component
public class GxhSpglXmjbxxbServiceImpl implements IGxhSpglXmjbxxbService {
    ...
    public int deleteByGuid(String guid) {
        return new GxhSpglXmjbxxbService().deleteByGuid(guid);
    }
    ...
    public int update(SpglXmjbxxb record) {
        return new GxhSpglXmjbxxbService().update(record);
    }
    ...
    public SpglXmjbxxb find(Object primaryKey) {
        return new GxhSpglXmjbxxbService().find(primaryKey);
    }
    ...
    public SpglXmjbxxb find(String sql, Object... args) {
        return new GxhSpglXmjbxxbService().find(sql, args);
    }
    ...
    public List<SpglXmjbxxb> findList(String sql, Object... args) {
        return new GxhSpglXmjbxxbService().findList(sql, args);
    }
    ...
    public List<SpglXmjbxxb> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return new GxhSpglXmjbxxbService().findList(sql, pageNumber, pageSize, args);
    }
    ...
    public Integer countSpglXmspgcxxb(String sql, Object... args) {
        return new GxhSpglXmjbxxbService().countSpglXmspgcxxb(sql, args);
    }

    @Override
    public List<SpglXmjbxxb> getSpglXmjbxxbListByCondition(Map<String, String> map) {
        return new GxhSpglXmjbxxbService().getSpglXmjbxxbListByCondition(map);
    }

    @Override
    public int insertHighGo(SpglXmjbxxb spglXmjbxxb) {
        return new GxhSpglXmjbxxbService().insertHighGo(spglXmjbxxb);
    }
