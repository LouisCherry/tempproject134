...
import com.epoint.zbxfdj.xfdj.spglxmspgctbcxxxb.api.ISpglXmspgctbcxxxbService;
...
/**
 * 项目审批过程特别程序信息表对应的后台service实现类
 *
 * @author Anber
 * @version [版本号, 2022-12-22 21:30:33]
 */
@Component
public class SpglXmspgctbcxxxbServiceImpl implements ISpglXmspgctbcxxxbService {
    /**
     * 更新数据
     *
    ...
    public int updateSjsczt(String status, String id) {
        return new SpglXmspgctbcxxxbService().updateSjsczt(status, id);
    }
    ...
    public SpglXmspgctbcxxxb find(Object primaryKey) {
        return new SpglXmspgctbcxxxbService().find(primaryKey);
    }
    ...
    public SpglXmspgctbcxxxb find(String sql, Object... args) {
        return new SpglXmspgctbcxxxbService().find(sql, args);
    }
    ...
    public List<SpglXmspgctbcxxxb> findList(String sql, Object... args) {
        return new SpglXmspgctbcxxxbService().findList(sql, args);
    }
    ...
    public List<SpglXmspgctbcxxxb> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return new SpglXmspgctbcxxxbService().findList(sql, pageNumber, pageSize, args);
    }
    ...
    public Integer countSpglXmspgctbcxxxb(String sql, Object... args) {
        return new SpglXmspgctbcxxxbService().countSpglXmspgctbcxxxb(sql, args);
    }
    ...
    public List<SpglXmspgctbcxxxb> findListBySjsczt(Integer sjsczt) {
        return new SpglXmspgctbcxxxbService().findListBySjsczt(sjsczt);
    }
