 ...
 * @作者 shibin
 */
@RestController("hudongxiezhulisttabaction")
@Scope("request")
public class HuDongXieZhuListTabAction extends BaseController {
    ...
    public void initTabData() {
        ...
        shzbj.put("code", "zbcx");
        shzbj.put("url", "jiningzwfw/sghd/projectjianguan/auditprojectjianguanlist");
