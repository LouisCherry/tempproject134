...
/**
 * 前四阶段信息配置表对应的后台service
 * 
 * @author lzhming
 * @version [版本号, 2023-03-17 08:57:44]
 */
public class AuditSpPhaseBaseinfoService
{
    /**
     * 数据增删改查组件
     */
    ...
    public AuditSpPhaseBaseinfoService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditSpPhaseBaseinfo.class, guid);
    ...
    public AuditSpPhaseBaseinfo find(Object primaryKey) {
        return baseDao.find(AuditSpPhaseBaseinfo.class, primaryKey);
    }
    ...
    public AuditSpPhaseBaseinfo find(String sql, Object... args) {
        return baseDao.find(sql, AuditSpPhaseBaseinfo.class, args);
    }
    ...
    public List<AuditSpPhaseBaseinfo> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditSpPhaseBaseinfo.class, args);
    }
    ...
    public List<AuditSpPhaseBaseinfo> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditSpPhaseBaseinfo.class, args);
    }
    ...
    public List<AuditSpPhaseBaseinfo> getAllPhaseBaseinfo() {
        String sql = "select * from AUDIT_SP_PHASE_BASEINFO where 1=1 ";
        return baseDao.findList(sql, AuditSpPhaseBaseinfo.class);
    }
    ...
    public List<AuditSpPhaseBaseinfo> getAuditSpPhaseBaseinfoListByCondition(Map<String, String> conditionMap) {
        ...
        String allSql = sqlManageUtil.buildSqlComoplete(AuditSpPhaseBaseinfo.class, conditionMap);       
        return baseDao.findList(allSql, AuditSpPhaseBaseinfo.class);
    }
}
