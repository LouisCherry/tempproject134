...
/**
 * 投资项目目录清单对应的后台service
 * 
 * @author Administrator
 * @version [版本号, 2020-09-26 12:07:55]
 */
public class TzxmmuqdService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(Tzxmmuqd.class, guid);
    ...
    public Tzxmmuqd find(Object primaryKey) {
        return baseDao.find(Tzxmmuqd.class, primaryKey);
    }
    ...
    public Tzxmmuqd find(String sql,  Object... args) {
        return baseDao.find(sql, Tzxmmuqd.class, args);
    }
    ...
    public List<Tzxmmuqd> findList(String sql, Object... args) {
        return baseDao.findList(sql, Tzxmmuqd.class, args);
    }
    ...
    public List<Tzxmmuqd> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, Tzxmmuqd.class, args);
    }
    ...
    public Tzxmmuqd selectTzxmmuqd(String xzqhdm, String permitindustry, String projecttype) {
        String sql="select * from tzxmmuqd where xzqhbm=? and mllx=? and mlhyfl=?";
        return baseDao.find(sql, Tzxmmuqd.class, xzqhdm,projecttype,permitindustry);
    }
}
