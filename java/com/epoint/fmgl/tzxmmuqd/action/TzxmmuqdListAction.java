...
import com.epoint.fmgl.tzxmmuqd.impl.TzxmmuqdServiceImpl;
 ...
 */
@RestController("tzxmmuqdlistaction")
@Scope("request")
public class TzxmmuqdListAction  extends BaseController
{
	@Autowired
        ...
        if (model == null) {
            model = new DataGridModel<Tzxmmuqd>()
            {
                ...
                public List<Tzxmmuqd> fetchData(int first, int pageSize, String sortField, String sortOrder) {
                    ...
                    List<Tzxmmuqd> list = service.findList(
                            ListGenerator.generateSql("tzxmmuqd", conditionSql, sortField, sortOrder), first, pageSize,
                            conditionList.toArray());
                   int count = service.countTzxmmuqd(ListGenerator.generateSql("tzxmmuqd", conditionSql), conditionList.toArray());
