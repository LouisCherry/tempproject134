...
@Component
@Service
public class ProgramstatisticServiceImpl implements IProgramstatisticService
{
    /**
     * 插入数据
     * 
    ...
    public int insert(Programstatistic record) {
        return new ProgramstatisticService().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new ProgramstatisticService().deleteByGuid(guid);
    }
    ...
    public int update(Programstatistic record) {
        return new ProgramstatisticService().update(record);
    }
    ...
    public Programstatistic find(Object primaryKey) {
       return new ProgramstatisticService().find(primaryKey);
    }
    ...
    public Programstatistic find(String sql, Object... args) {
        return new ProgramstatisticService().find(args);
    }
    ...
    public List<Programstatistic> findList(String sql, Object... args) {
       return new ProgramstatisticService().findList(sql,args);
    }
    ...
    public List<Programstatistic> findList(String sql, int pageNumber, int pageSize, Object... args) {
       return new ProgramstatisticService().findList(sql,pageNumber,pageSize,args);
    }
    ...
    public List<Programstatistic> findListByProgramform(String programform) {
        return new ProgramstatisticService().findListByProgramform(programform);
    }
    ...
    public void deleteByRowguid(String rowguid) {
        new ProgramstatisticService().deleteByRowguid(rowguid);
    }
