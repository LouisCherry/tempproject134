...
@Component
@Service
public class InfopubPlayServiceImpl implements IInfopubPlayService
{
    /**
     * 插入数据
     * 
    ...
    public int insert(InfopubPlay record) {
        return new InfopubPlayService().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new InfopubPlayService().deleteByGuid(guid);
    }
    ...
    public int update(InfopubPlay record) {
        return new InfopubPlayService().update(record);
    }
    ...
    public InfopubPlay find(Object primaryKey) {
       return new InfopubPlayService().find(primaryKey);
    }
    ...
    public InfopubPlay find(String sql, Object... args) {
        return new InfopubPlayService().find(args);
    }
    ...
    public List<InfopubPlay> findList(String sql, Object... args) {
       return new InfopubPlayService().findList(sql,args);
    }
    ...
    public List<InfopubPlay> findList(String sql, int pageNumber, int pageSize, Object... args) {
       return new InfopubPlayService().findList(sql,pageNumber,pageSize,args);
    }
