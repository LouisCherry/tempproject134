package com.epoint.zoucheng.znsb.auditznsbcommentmatter.service;
...
/**
 * 工作台评价事项记录表对应的后台service
 * 
 * @author chencong
 * @version [版本号, 2020-04-08 13:37:36]
 */
public class ZCAuditZnsbCommentMatterService
{
 /**
     * 数据增删改查组件
     */
    ...
    public ZCAuditZnsbCommentMatterService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(ZCAuditZnsbCommentMatter.class, guid);
    ...
    public ZCAuditZnsbCommentMatter find(Object primaryKey) {
        return baseDao.find(ZCAuditZnsbCommentMatter.class, primaryKey);
    }
    ...
    public ZCAuditZnsbCommentMatter find(String sql,  Object... args) {
        return baseDao.find(sql, ZCAuditZnsbCommentMatter.class, args);
    }
    ...
    public List<ZCAuditZnsbCommentMatter> findList(String sql, Object... args) {
        return baseDao.findList(sql, ZCAuditZnsbCommentMatter.class, args);
    }
    ...
    public List<ZCAuditZnsbCommentMatter> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, ZCAuditZnsbCommentMatter.class, args);
    }
    ...
    public List<ZCAuditZnsbCommentMatter> getAuditZnsbCommentMatterByCard(String card) {
        String strSql = " select * from audit_znsb_comment_matter where commentcard = ? ";
        ...
        return baseDao.findList(strSql, ZCAuditZnsbCommentMatter.class, card);
    }
}
