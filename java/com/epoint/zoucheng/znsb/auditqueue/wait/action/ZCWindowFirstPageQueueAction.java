package com.epoint.zoucheng.znsb.auditqueue.wait.action;
...
@RestController("zcwindowfirstpagequeueaction")
@Scope("request")
public class ZCWindowFirstPageQueueAction extends BaseController
{
        ...
        if (StringUtil.isNotBlank(MacAddress)) {
            ...
            if ("status=0".equals(url)) {
                ...
                if (StringUtil.isNotBlank(url)) {
                    redirect("jiningzwfw/zoucheng/epointqueue/wait/" + url);
                }
                else {
