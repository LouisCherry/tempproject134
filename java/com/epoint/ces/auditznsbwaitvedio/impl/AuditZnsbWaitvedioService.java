 ...
 */
public class AuditZnsbWaitvedioService
{
 /**
     * 数据增删改查组件
     */
    ...
    public AuditZnsbWaitvedioService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditZnsbWaitvedio.class, guid);
    ...
    public AuditZnsbWaitvedio find(Object primaryKey) {
        return baseDao.find(AuditZnsbWaitvedio.class, primaryKey);
    }
    ...
    public AuditZnsbWaitvedio find(String sql,  Object... args) {
        return baseDao.find(sql, AuditZnsbWaitvedio.class, args);
    }
    ...
    public List<AuditZnsbWaitvedio> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditZnsbWaitvedio.class, args);
    }
    ...
    public List<AuditZnsbWaitvedio> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditZnsbWaitvedio.class, args);
    }
    ...
    public  AuditZnsbWaitvedio findfirst(String condition) {
        ...
        String sql ="select * from audit_znsb_waitvedio where 1=1  "+condition+" ORDER BY ordernum DESC LIMIT 1 ";
        return commondao.find(sql,AuditZnsbWaitvedio.class);
    }
}
