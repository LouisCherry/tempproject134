package com.epoint.ces.auditnotifydocattachinfo.api;
import java.io.Serializable;
import java.util.List;
import com.epoint.ces.auditnotifydocattachinfo.api.entity.AuditNotifydocAttachinfo;

/**
 * 办件文书信息表对应的后台service接口
 * 
 * @author jiem
 * @version [版本号, 2022-03-15 14:02:49]
 */
public interface IAuditNotifydocAttachinfoService extends Serializable
{ 
    ...
    List<AuditNotifydocAttachinfo> findPage(String buildSqlComoplete, int first, int pageSize);
}
