...
/**
 * 建筑业企业资质数据库工作流页面对应的后台
 * 
 * @author 86180
 * @version [版本号, 2020-04-15 11:11:06]
 */
@RestController("jnbuildpartworkflowtabsaction")
@Scope("request")
public class JnBuildPartWorkFlowTabsAction extends WorkflowBaseController
{
    ...
    // 数据表名
    private String sqlTableName = "jn_build_part";
