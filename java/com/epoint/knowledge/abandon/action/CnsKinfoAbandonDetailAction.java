 ...
 */
@RestController("cnskinfoabandondetailaction")
@Scope("request")
public class CnsKinfoAbandonDetailAction extends BaseController
{
    /**
    * 
    */
    ...
    public void pageLoad() {
        ...
        cnsKinfoAbandon=cnsKinfoAbandonService.getBeanByGuid(guid);
        dataBean = cnsKinfoService.getBeanByGuid(cnsKinfoAbandon.getKguid());
        ...
        if (model == null) {
            model = new DataGridModel<CnsKinfoStep>()
            {
                ...
                public List<CnsKinfoStep> fetchData(int first, int pageSize, String sortField, String sortOrder) {
                    List<CnsKinfoStep> list = kinfoStepService.getAllStepByKguid(cnsKinfoAbandon.getKguid());
    ...
    public void closeMsg() {
        //---结束掉该知识待办---
        messageService.deleteByMessageItemGuid(messageItemGuid);
    }

    public CnsKinfoAbandon getCnsKinfoAbandon() {
        return cnsKinfoAbandon;
    }

    public void setCnsKinfoAbandon(CnsKinfoAbandon cnsKinfoAbandon) {
        this.cnsKinfoAbandon = cnsKinfoAbandon;
    }
