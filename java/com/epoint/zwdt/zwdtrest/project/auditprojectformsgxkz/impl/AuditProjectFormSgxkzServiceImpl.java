...
public class AuditProjectFormSgxkzServiceImpl implements IAuditProjectFormSgxkzService
{
    ...
    public AuditProjectFormSgxkz find(String projectguid) {
        return new AuditProjectFormSgxkzService().find(projectguid);
    }
     ...
     */
    public AuditProjectFormSgxkz find(String sql, String projectguid) {
        return new AuditProjectFormSgxkzService().find(projectguid);
    }
    ...
    public AuditProjectFormSgxkzDanti getDantiByRowguid(String rowguid){
        return new AuditProjectFormSgxkzService().getDantiByRowguid(rowguid);
    }
    
    public List<AuditProjectFormSgxkzDanti> findDantiList(String projectguid) {
        return new AuditProjectFormSgxkzService().findDantiList(projectguid);
    }
    ...
    public AuditProjectFormSgxkz find(String sql, Object... args) {
        return new AuditProjectFormSgxkzService().find(sql, args);
    }
}
