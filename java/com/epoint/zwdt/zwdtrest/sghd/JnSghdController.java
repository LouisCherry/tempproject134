package com.epoint.zwdt.zwdtrest.sghd;
...
import com.epoint.zwdt.zwdtrest.sghd.api.*;
import com.epoint.zwdt.zwdtrest.sghd.service.RenlingService;
import com.epoint.zwdt.zwdtrest.sghd.service.SgytSpxxProjectService;
    ...
    public String getsglist(@RequestBody String params, @Context HttpServletRequest request) {
        try {
            ...
            if (ZwdtConstant.SysValidateData.equals(token)) {
                JSONObject obj = (JSONObject) jsonObject.get("params");
                //必填 登陆用户名
                String loginid = CheckTokenUtil.getLoginId(request);
                log.info("loginid:"+loginid);
