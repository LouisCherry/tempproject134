package com.epoint.zwdt.zwdtrest.task.audittaskpopinfo.api;
...
/**
 * 弹窗信息维护对应的后台service接口
 * 
 * @author dahe
 * @version [版本号, 2024-11-26 10:20:20]
 */
public interface IAuditTaskPopInfoService extends Serializable
{ 
    ...
    AuditTaskPopInfo find(Map<String, String> map);
}
