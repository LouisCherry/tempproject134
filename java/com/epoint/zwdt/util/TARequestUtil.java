...
public class TARequestUtil
{
    ...
    public static String getResult(String address, Map<String, String> paramsMap) throws Exception{
    	...
    	String param = "params=" + paramsMap.get("params"); //params需要按照要求的数据类型
