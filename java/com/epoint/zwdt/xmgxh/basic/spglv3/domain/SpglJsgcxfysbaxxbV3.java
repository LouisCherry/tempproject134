 ...
 */
@Entity(table = "SPGL_JSGCXFYSBAXXB_V3", id = "rowguid")
public class SpglJsgcxfysbaxxbV3 extends BaseEntity implements Cloneable
{
     ...
     * 备案表编号
     */
    public String getBabbh() {
        return super.get("babbh");
    }

    public void setBabbh(String babbh) {
        super.set("babbh", babbh);
    }
     ...
     * 建设工程规划许可文件（依法需要办理的）
     */
    public String getGcghxkzwj() {
        return super.get("gcghxkzwj");
    }

    public void setGcghxkzwj(String gcghxkzwj) {
        super.set("gcghxkzwj", gcghxkzwj);
    }

    /**
     * 建设工程规划许可日期
     */
    public Date getJsgcghxkrq() {
        return super.getDate("jsgcghxkrq");
    }

    public void setJsgcghxkrq(Date jsgcghxkrq) {
        super.set("jsgcghxkrq", jsgcghxkrq);
    }
     ...
     */
    public String getCcjgtzswh() {
        return super.get("ccjgtzswh");
    }

    public void setCcjgtzswh(String ccjgtzswh) {
        super.set("ccjgtzswh", ccjgtzswh);
    }
