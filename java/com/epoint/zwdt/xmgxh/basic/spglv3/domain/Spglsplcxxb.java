 ...
 */
@Entity(table = "SPGL_SPLCXXB_V3", id = "rowguid")
public class Spglsplcxxb extends BaseEntity implements Cloneable
{
    ...
    */
    public String getSplcmc() {
        return super.get("splcmc");
    }

    public void setSplcmc(String splcmc) {
        super.set("splcmc", splcmc);
    }
    ...
    * 审批流程说明
    */
    public String getSplcsm() {
        return super.get("splcsm");
    }

    public void setSplcsm(String splcsm) {
        super.set("splcsm", splcsm);
    }
    ...
    */
     ...
     * 对应标准审批流程类型
     */
    public Integer getDybzsplclx() {
        return super.getInt("dybzsplclx");
    }

    public void setDybzsplclx(Integer dybzsplclx) {
        super.set("dybzsplclx", dybzsplclx);
    }
     ...
     * 审批流程图地址
     */
     public String getSplctdz() {
         return super.get("splctdz");
     }

     public void setSplctdz(String splctdz) {
         super.set("splctdz", splctdz);
     }
