 ...
 */
public class SpglXmdtxxbV3Service
{
    /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(SpglXmdtxxbV3.class, guid);
    ...
    public SpglXmdtxxbV3 find(Object primaryKey) {
        return baseDao.find(SpglXmdtxxbV3.class, primaryKey);
    }
    ...
    public SpglXmdtxxbV3 find(String sql, Object... args) {
        return baseDao.find(sql, SpglXmdtxxbV3.class, args);
    }
    ...
    public List<SpglXmdtxxbV3> findList(String sql, Object... args) {
        return baseDao.findList(sql, SpglXmdtxxbV3.class, args);
    }
    ...
    public List<SpglXmdtxxbV3> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, SpglXmdtxxbV3.class, args);
    }
     ...
     * @see [类、类#方法、类#成员]
     */
    public PageData<SpglXmdtxxbV3> getAllRecordByPage(Class<? extends BaseEntity> baseClass,
