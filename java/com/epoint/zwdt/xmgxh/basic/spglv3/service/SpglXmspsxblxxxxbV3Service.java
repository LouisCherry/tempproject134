...
public class SpglXmspsxblxxxxbV3Service
{
    ...
    public AuditCommonResult<PageData<SpglXmspsxblxxxxbV3>> getAllByPage(Map<String, String> map, int first,
            int pageSize, String sortField, String sortOrder) {
        AuditCommonResult<PageData<SpglXmspsxblxxxxbV3>> auditCommonResult = new AuditCommonResult<>();
        try {
            SQLManageUtil sqlManageUtil = new SQLManageUtil(SpglXmspsxblxxxxbV3.class);
            PageData<SpglXmspsxblxxxxbV3> pageData = sqlManageUtil.getDbListByPage(SpglXmspsxblxxxxbV3.class, map,
    ...
    public PageData<SpglXmspsxblxxxxbV3> getRiskRepeatData(Map<String, String> conditionMap, Integer first,
            Integer pageSize) {
        PageData<SpglXmspsxblxxxxbV3> result = new PageData<>();
    ...
    public List<String> filterHjltSxslbm(List<String> spsxslbm) {
        if (spsxslbm == null || spsxslbm.isEmpty()) {
