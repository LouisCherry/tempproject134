...
/**
 * 住建部_项目审批事项前期意见信息表对应的后台service
 * 
 * @author zhpengsy
 * @version [版本号, 2018-11-16 15:09:44]
 */
public class SpglXmspsxzqyjxxbV3Service
{
    /**
     * 数据增删改查组件
     */
    ...
    public SpglXmspsxzqyjxxbV3Service() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(SpglXmspsxzqyjxxbV3.class, guid);
    ...
    public SpglXmspsxzqyjxxbV3 find(Object primaryKey) {
        return baseDao.find(SpglXmspsxzqyjxxbV3.class, primaryKey);
    }
    ...
    public SpglXmspsxzqyjxxbV3 find(String sql, Object... args) {
        return baseDao.find(sql, SpglXmspsxzqyjxxbV3.class, args);
    }
    ...
    public List<SpglXmspsxzqyjxxbV3> findList(String sql, Object... args) {
        return baseDao.findList(sql, SpglXmspsxzqyjxxbV3.class, args);
    }
    ...
    public List<SpglXmspsxzqyjxxbV3> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, SpglXmspsxzqyjxxbV3.class, args);
    }

    public AuditCommonResult<PageData<SpglXmspsxzqyjxxbV3>> getAllByPage(Map<String, String> map, int first, int pageSize,
            String sortField, String sortOrder) {
        AuditCommonResult<PageData<SpglXmspsxzqyjxxbV3>> auditCommonResult = new AuditCommonResult<PageData<SpglXmspsxzqyjxxbV3>>();
        try {
            SQLManageUtil sqlManageUtil = new SQLManageUtil(SpglXmspsxzqyjxxbV3.class);
            PageData<SpglXmspsxzqyjxxbV3> pageData = sqlManageUtil.getDbListByPage(SpglXmspsxzqyjxxbV3.class, map, first,
    ...
    public List<SpglXmspsxzqyjxxbV3> getAllRecord(Class<? extends BaseEntity> baseClass,
    ...
    public Integer getAllRecordCount(Class<? extends BaseEntity> baseClass, Map<String, String> conditionMap) {
        List<SpglXmspsxzqyjxxbV3> result = getAllRecord(baseClass, conditionMap);
        if (result != null) {
            return result.size();
        }
        else {
    ...
    public PageData<SpglXmspsxzqyjxxbV3> getAllRecordByPage(Class<? extends BaseEntity> baseClass,
