...
@Component
@Service
public class ProsavetimeServiceImpl implements IProsavetimeService
{
    /**
     * 插入数据
     * 
    ...
    public int insert(Prosavetime record) {
        return new ProsavetimeService().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new ProsavetimeService().deleteByGuid(guid);
    }
    ...
    public int update(Prosavetime record) {
        return new ProsavetimeService().update(record);
    }
    ...
    public Prosavetime find(Object primaryKey) {
       return new ProsavetimeService().find(primaryKey);
    }
    ...
    public Prosavetime find(String sql, Object... args) {
        return new ProsavetimeService().find(args);
    }
    ...
    public List<Prosavetime> findList(String sql, Object... args) {
       return new ProsavetimeService().findList(sql,args);
    }
    ...
    public List<Prosavetime> findList(String sql, int pageNumber, int pageSize, Object... args) {
       return new ProsavetimeService().findList(sql,pageNumber,pageSize,args);
    }
