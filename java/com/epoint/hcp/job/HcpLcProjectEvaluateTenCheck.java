 ...
 * @since [产品/模块版本]
 */
public class HcpLcProjectEvaluateTenCheck implements Callable<String> {
    ...
    public HcpLcProjectEvaluateTenCheck() {
        super();
    }
    ...
    class Task implements Runnable {
        ...
        public void run() {
            try {
                List<lcprojectten> projects = iHcpService.getLcEvaluateSbTenList(start, size);
                    ...
                    for (lcprojectten project : projects) {
                        ...
                        if (StringUtil.isBlank(mobile)) {
                            ...
                            if (flag) {
                                ...
                                iHcpService.updateLcProjectten(status, project.getRowguid());
                                EpointFrameDsManager.commit();
                            } else {
                                iHcpService.updateLcProjecttwo("2", project.getRowguid());
                            }
     ...
     * @see [类、类#方法、类#成员]
     */
    public String turnhcpevaluate(lcprojectten auditProject, int serviceNumber, String servicename, String newserviceTime, String type) {
    ...
    private void turnEvaluate(String taskType, String areacode, String projectno, String userName, String serviceNumber) {
        ...
        Record r = new Record();
        r.setSql_TableName("evainstanceten");
