...
public class HcpEvainstanceSuppJob implements Job {
	...
	private void doService() {
		try {
			...
			List<Evainstance> waitevaluates = iHcpService.getHcpInstacneSuppList();
			if (waitevaluates == null || waitevaluates.isEmpty()) {
				log.info("===============无需要待补推的办件评价数据，结束服务===============");
			} else {
				for (Evainstance evainstan : waitevaluates) {
