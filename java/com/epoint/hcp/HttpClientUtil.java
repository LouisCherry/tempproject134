...
public class HttpClientUtil {
    ...
    private static final int CONNECT_TIMEOUT = 50000;  //连接超时1s
    private static final int READ_TIMEOUT = 50000;     //读取超时2s
    ...
    public String getResponseBodyAsStringWithMapHttpget(String targetUrl,Map params)throws Exception{
        
        return (String)setGetRequestWithMap(targetUrl,TYPE_STRING,params);
    }  
    
  public String getResponseBodyAsStringWithMapHttpget(String targetUrl,Map params,String charset)throws Exception{
        
        return (String)setGetRequestWithMap(targetUrl,TYPE_STRING,params,charset);
    }
  
  public String getResponseBodyAsStringWithMapHttpget(String targetUrl,Map params,String charset,Map<String, String> headers)throws Exception{
...
//            }
            ...
            if(StringUtils.equals(TYPE_STRING,responseType)){
                ...
                //LOGGER.info("resp data:" + new String((byte[])responseResult,"utf-8"));
            }
