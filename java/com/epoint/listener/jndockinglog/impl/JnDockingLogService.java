...
/**
 * 业务中台接口日志表对应的后台service
 * 
 * @author 15056
 * @version [版本号, 2024-01-08 14:41:09]
 */
public class JnDockingLogService
{
    /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(JnDockingLog.class, guid);
    ...
    public JnDockingLog find(Object primaryKey) {
        return baseDao.find(JnDockingLog.class, primaryKey);
    }
    ...
    public JnDockingLog find(String sql, Object... args) {
        return baseDao.find(sql, JnDockingLog.class, args);
    }
    ...
    public List<JnDockingLog> findList(String sql, Object... args) {
        return baseDao.findList(sql, JnDockingLog.class, args);
    }
    ...
    public List<JnDockingLog> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, JnDockingLog.class, args);
    }
