 ...
 * @Date: 2024/1/8 15:48
 */
public class JnRestUtil
{
    private static Logger log = Logger.getLogger(JnRestUtil.class);
    ...
    public static Map<String, String> getHeaderMap() {
        ...
        try {
            ...
            String signature = hmacSha256(
                    "x-aep-appkey=" + appkey + "&x-aep-nonce=" + nonce + "&x-aep-timestamp=" + timestamp, appsecret);
     ...
     * @date 2024/1/9 15:24
     */
    public static void insertJnDockingLog(String url, String requestXml, int callresultid, String callresultexpl,
            String interfaceName) {
        IJnDockingLogService iJnDockingLog = ContainerFactory.getContainInfo().getComponent(IJnDockingLogService.class);
        Date now = new Date();
        JnDockingLog JnDockingLog = new JnDockingLog();
        JnDockingLog.setRowguid(UUID.randomUUID().toString());
        JnDockingLog.setCreated_time(now);
        JnDockingLog.setOperatedate(now);
        JnDockingLog.setBusinessid("省空间对接");
        JnDockingLog.setBusinessname("省空间对接");
        JnDockingLog.setInterfacename(interfaceName);
        JnDockingLog.setInterfaceuri(url);
        JnDockingLog.setParams(requestXml);
        JnDockingLog.setCallresultid(callresultid);
        JnDockingLog.setCallresultexpl(callresultexpl);
        iJnDockingLog.insert(JnDockingLog);
    }
    ...
    public static String post(String url, JSONObject jsonObject) {
        try {
            ...
            // .addHeader("x-aep-signature", hmacSha256(appSecretValue,
            // getBody(uuid, timestamp)))
            // .addHeader("Content-Type", "application/json")
            // .addHeader("User-Agent", "PostmanRuntime/7.15.0")
            // .addHeader("Accept", "*/*")
            // .addHeader("Cache-Control", "no-cache")
            // .addHeader("Postman-Token",
            // "da8cbc0e-2b10-4b30-a633-a7e001b27a55,21d58b53-f676-478d-b9ec-a039c306da6d")
