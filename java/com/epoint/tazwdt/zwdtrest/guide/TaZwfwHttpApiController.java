package com.epoint.tazwdt.zwdtrest.guide;
...
public class TaZwfwHttpApiController
{
    /**
     * 日志
     */
    ...
    public String setAppplyProject(@RequestBody String params) throws Exception {
        log.info("=====开始调用接口TaZwfwHttpApiController.setApplyProject=====");
        ...
        try {
            ...
            if (ZwdtConstant.SysValidateData.equals(token)) {
                ...
                String flowsn = jsonObject.getString("flowsn");
                ...
                if (StringUtil.isNotBlank(flowsn)) {
                    ...
                    String newItemCode = jsonObject.getString("newItemCode");
                    String taskId = jsonObject.getString("taskId");
                    Record auditTaskTaian = daTingService.getAuditTaskTaianByTaskId(taskId);
                    String url = "";
                    String type = "";
                    String [] sendParam = auditTaskTaian.getStr("yyyzSendUrl").split("_SPI_");
                    String itemid = auditTaskTaian.getStr("scxtcode"); //针对对接工业生产的自建系统，新增推送itemid字段
                    ...
                    String postURL = url;
//                    String postURL = "http://60.216.97.246:8089/sdfda/applyApi/receiveSno";
                    ...
                    log.info("=======结束调用TaZwfwHttpApiController.setApplyProject接口=======");
    ...
    public String setApplyProjectInfo(@RequestBody String params) throws Exception {
        log.info("=====开始调用接口TaZwfwHttpApiController.setApplyProjectInfo=====");
        log.info("========params========" + params);
        try {
                        ...
                        if(StringUtil.isNotBlank(formsInfo)) {
                            ...
                            for (int i = 0; i < sxbdbms.length; i++) {
                                if(formsInfo.contains(sxbdbms[i])) {
                                    if(sxbdbms[i].contains("_LIST") || "DC_YYYZ_QSXK_XSGC".equals(sxbdbms[i]) || "DC_YYYZ_FSYZL_TWS_MF".equals(sxbdbms[i]) || "DC_YYYZ_XQJY_JXSS".equals(sxbdbms[i])
                                            || "DC_YYYZ_XQJY_JZG".equals(sxbdbms[i]) || "DC_RES_SAFE_HR".equals(sxbdbms[i]) || "DC_YYYZ_YSGC".equals(sxbdbms[i]) || "DC_SUB".equals(sxbdbms[i])
                                            || "DC_YYYZ_QSXK_SJGC".equals(sxbdbms[i]) || "DC_YYYZ_YSJYXK_SB".equals(sxbdbms[i]) || "DC_YYYZ_FSYZL_TWS".equals(sxbdbms[i]) || "DC_YYYZ_QSXK_TSGC".equals(sxbdbms[i]) || "DC_YYYZ_YLJGXK_YQSB".equals(sxbdbms[i]) || "DC_YYYZ_J_JZSGQYAQFZR".equals(sxbdbms[i])
                                            || "DC_YYYZ_QSXK_XSGC".equals(sxbdbms[i]) || "DC_YYYZ_QSXK_XSGC".equals(sxbdbms[i]) || "DC_YYYZ_QSXK_TSGC".equals(sxbdbms[i]) || "DC_YYYZ_JZSGQYAZZAQ".equals(sxbdbms[i]) || "DC_YYYZ_JZSGQYTZZY".equals(sxbdbms[i]) || "DC_YYYZ_GYCPSCXK".equals(sxbdbms[i])
                                            || "DC_YYYZ_JZYQYZZRY".equals(sxbdbms[i]) || "DC_YYYZ_SXRSGXKLB".equals(sxbdbms[i]) || "DC_YYYZ_JGWWSCXK".equals(sxbdbms[i]) || "DC_YYYZ_JYJCJGSCDZ".equals(sxbdbms[i]) || "DC_YYYZ_JYXXCSXX".equals(sxbdbms[i])) {
                                        paramList.put(sxbdbms[i], JSONObject.parseArray(param.get(sxbdbms[i]).toString().replaceAll(";", ",")));
                                    }else {
                                        
//                                    String param2 = param.getString(sxbdbms[i]);
//                                    JSONObject formParams = JSONObject.parseObject(param2);
                                        paramList.put(sxbdbms[i], JSONObject.parseObject(param.get(sxbdbms[i]).toString().replaceAll(";", ",")));
                                    }
                                }
...
//                        }
                        ...
                        xml.append("<XML_DATA><SPItemListDef><rows>"+paramList+"</rows></SPItemListDef></XML_DATA>");
                        ...
                        log.info("========开始输出基本信息拼接的xml:" + newXmlStr + "========");
                        ...
                        log.info("=======结束调用TaZwfwHttpApiController.setApplyProjectInfo接口=======");
    ...
    public String getApplyProjectMaterial(@RequestBody String params) throws Exception {
        log.info("=====开始调用接口TaZwfwHttpApiController.getApplyProjectMaterial=====");
        log.info("========params========" + params);
        try {
            String param1 = URLDecoder.decode(params,"utf-8");
            JSONObject paramObj = JSONObject.parseObject(param1);
                ...
                if (StringUtil.isNotBlank(flowsn)) {
                    ...
                    if (StringUtil.isNotBlank(auditProject)) {
                        ...
                        if (StringUtil.isNotBlank(auditSpIYyyzMaterialList) && auditSpIYyyzMaterialList.size() > 0) {
                            ...
                            log.info("=======结束调用TaZwfwHttpApiController.getApplyProjectMaterial接口======="
                                    + EpointDateUtil.convertDate2String(new Date(), EpointDateUtil.DATE_TIME_FORMAT));
                            return newXmlStr;
                        }
                        else {
    ...
    public String acceptBusinessInfo(@RequestBody String params) throws Exception {
        log.info("=====开始调用接口TaZwfwHttpApiController.acceptBusinessInfo=====");
        log.info("========params========" + params);
        try {
            String param1 = URLDecoder.decode(params,"utf-8");
            JSONObject paramObj = JSONObject.parseObject(param1);
            ...
            if (ZwdtConstant.SysValidateData.equals(token)) {
                ...
                if (StringUtil.isNotBlank(flowsn)) {
                    ...
                    if (StringUtil.isNotBlank(auditProject)) {
                        ...
                        // params, "",
                        // "");
                        log.info("=======结束调用TaZwfwHttpApiController.acceptBusinessInfo接口======="
                                + EpointDateUtil.convertDate2String(new Date(), EpointDateUtil.DATE_TIME_FORMAT));
                        return newXmlStr;
                    }
                    else {
    ...
    public String completeBusinessInfo(@RequestBody String params) throws Exception {
        log.info("=====开始调用接口TaZwfwHttpApiController.completeBusinessInfo=====");
        log.info("========params========" + params);
        try {
            String param1 = URLDecoder.decode(params,"utf-8");
            JSONObject paramObj = JSONObject.parseObject(param1);
    ...
    auditProject.setPromiseenddate(shouldEndDate);
                        ...
                        // params, "",
                        // "");
                        log.info("=======结束调用TaZwfwHttpApiController.completeBusinessInfo接口======="
                                + EpointDateUtil.convertDate2String(new Date(), EpointDateUtil.DATE_TIME_FORMAT));
                        return newXmlStr;
                    }
                    else {
