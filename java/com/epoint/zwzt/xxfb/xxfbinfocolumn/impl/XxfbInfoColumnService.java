 ...
 */
public class XxfbInfoColumnService
{
    /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(XxfbInfoColumn.class, guid);
    ...
    public Integer countXxfbInfoColumn(Map<String, Object> conditionMap) {
        ...
        String sql = new SqlHelper().getSqlComplete(XxfbInfoColumn.class, conditionUtil.getMap(), params);
    ...
    public XxfbInfoColumn find(Object primaryKey) {
        return baseDao.find(XxfbInfoColumn.class, primaryKey);
    }
    ...
    public XxfbInfoColumn find(Map<String, Object> conditionMap) {
        ...
        return baseDao.find(sql, XxfbInfoColumn.class, params.toArray());
    }
    ...
    public List<XxfbInfoColumn> findList(Map<String, Object> conditionMap) {
        List<Object> params = new ArrayList<>();
        String sql = new SqlHelper().getSqlComplete(XxfbInfoColumn.class, conditionMap, params);
        return baseDao.findList(sql, XxfbInfoColumn.class, params.toArray());
    }
    ...
    public PageData<XxfbInfoColumn> paginatorList(Map<String, Object> conditionMap, int pageNumber, int pageSize) {
        List<Object> params = new ArrayList<>();
        String sql = new SqlHelper().getSqlComplete(XxfbInfoColumn.class, conditionMap, params);
        List<XxfbInfoColumn> list = baseDao.findList(sql, pageNumber, pageSize, XxfbInfoColumn.class, params.toArray());
        int count = countXxfbInfoColumn(conditionMap);
        return new PageData<XxfbInfoColumn>(list, count);
    }
