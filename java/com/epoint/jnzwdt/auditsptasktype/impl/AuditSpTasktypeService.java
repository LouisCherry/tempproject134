...
public class AuditSpTasktypeService {
    ...
    public List<AuditSpTasktype> findByTaskId(List<String> taskids, String phaseid) {
        String sql = "select a.*,b.taskid from audit_sp_tasktype a inner join audit_sp_tasktype_r b on a.rowguid = b.tasktypeguid" +
                " where a.phaseid = ? and b.taskid in ('" + StringUtil.join(taskids, "','") + "') ";
        return baseDao.findList(sql, AuditSpTasktype.class, phaseid);
    }
}
