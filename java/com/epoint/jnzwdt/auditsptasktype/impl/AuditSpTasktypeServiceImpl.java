...
@Component
@Service
public class AuditSpTasktypeServiceImpl implements IAuditSpTasktypeService {
    /**
     * 插入数据
     *
    ...
    public int insert(AuditSpTasktype record) {
        return new AuditSpTasktypeService().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new AuditSpTasktypeService().deleteByGuid(guid);
    }
    ...
    public int update(AuditSpTasktype record) {
        return new AuditSpTasktypeService().update(record);
    }
    ...
    public AuditSpTasktype find(Object primaryKey) {
        return new AuditSpTasktypeService().find(primaryKey);
    }
    ...
    public AuditSpTasktype find(String sql, Object... args) {
        return new AuditSpTasktypeService().find(sql, args);
    }
    ...
    public List<AuditSpTasktype> findList(String sql, Object... args) {
        return new AuditSpTasktypeService().findList(sql, args);
    }
    ...
    public List<AuditSpTasktype> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return new AuditSpTasktypeService().findList(sql, pageNumber, pageSize, args);
    }
    ...
    public Integer countAuditSpTasktype(String sql, Object... args) {
        return new AuditSpTasktypeService().countAuditSpTasktype(sql, args);
    }

    @Override
    public List<AuditSpTasktype> findByTaskId(List<String> taskids, String phaseid) {
        return new AuditSpTasktypeService().findByTaskId(taskids, phaseid);
    }
}
