package com.epoint.audittask.audittaskkeyword.api;
...
public interface IAuditTaskKeywordService extends Serializable {
    ...
    List<AuditTaskKeyword> findListByCondition(Map<String, Object> map);

    void deleteByTaskid(String taskid);

    AuditTaskKeyword findByTaskid(String task_id);
}
