...
@RestController("jnaudittaskextenddetailaction")
@Scope("request")
public class JNAuditTaskExtendDetailAction extends BaseController {
    ...
    public void pageLoad() {
        ...
        AuditTaskExtension compareAuditTaskExtension = auditTaskExtensionImpl.getTaskExtensionByTaskGuid(compareTaskGuid, false).getResult();
        ...
        if (StringUtil.isNotBlank(auditTask.getTaskoutimgguid())) {// 外部流程图标识不为空
            /**
             * 根据业务guid获取附件名字和guid的数组,中间用;拼接
             * 参数: clientGuid - 业务guid，type - 大小附件标识 1:大附件;2:小附件
             * 返回: String[]name和guid
             **/
