package com.epoint.wechat.task.api;
 ...
 */
public interface IWeiChatTaskService extends Serializable
{
     ...
     *  @return
     */
    public Record findTaskIconByTaskid(String task_id);

    /**
     * 根据事项task_id获取事项信息
     * @authory shibin
     * @version 2019年10月3日 下午7:14:52
     * @param taskid
     * @return
     */
