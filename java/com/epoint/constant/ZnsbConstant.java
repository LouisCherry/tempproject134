package com.epoint.constant;

public class ZnsbConstant
{
    public static final int JOB_INIT_CODE = 0;
    public static final int JOB_SUCESS_CODE = 1;

    public static final int METHOD_USE = 1;
    public static final int METHOD_NOT_USE = 0;

    public static final String EVENT_METHOD = "ZnsbEventMethod";

    public static enum EQUIPTYPR
    {
        未分类(0), 排队叫号(1), 工具条叫号PAD(2);
    ...
    public enum UNITTYPR
    {
        未分类(0), 产品组件(1), 个性化组件(2);
    ...
    public static final String SMS_GET = "1";
    public static final String SMS_CALL = "2";
    public static final String SMS_TIQIAN = "3";
    public static final String SMS_RECALL = "4";

    public enum SMSTYPR
    {
        取号短信("1"), 叫号短信("2"), 提前短信("3"), 重呼短信("4"), 完成短信("5"), 事项分类预警短信("6"), 生日短信("7"),预约短信("8"), 过号短信("9"), 转号短信("10"), 缺纸短信("11");
    ...
    public static final String CONSTANT_STR_FOUR = "4";
    ...
    public static final String EQUIPMENT_TYPE_ZMQHJ = "11";// 桌面取号机
    public static final String EQUIPMENT_TYPE_YTJ24 = "12";// 24小时无人值守终端
    public static final String EQUIPMENT_TYPE_CABINET = "13";// 智能存储柜
    public static final String EQUIPMENT_TYPE_ROBOT = "14";// 智能机器人
    public static final String EQUIPMENT_TYPE_AZQHJ = "15";// 安卓取号机
    public static final String EQUIPMENT_TYPE_ZNDF = "16";// 智能导服
    public static final String EQUIPMENT_TYPE_JKSB = "17";// 监控设备
    public static final String EQUIPMENT_TYPE_XXFBP = "18";// 信息发布屏
    public static final String EQUIPMENT_TYPE_ZZDN = "19";// 自助电脑
    /**
     * app类型
     */
    ...
    public static final String TerminalApp_Type_ROBOT = "7";// 机器人
    public static final String TerminalApp_Type_AZQHJ = "8";// 安卓取号机
    public static final String TerminalApp_Type_ZNDF = "9";// 安卓取号机
    ...
    public static final String Qno_Status_Hangup = "4";// 挂起;
    /**
     * 设备状态
     */
    ...
    public static final String Evaluate_Status_Logout = "7";// 登出

    /**
     * 叫号平板推送状态
     */
    public static final String JHPAD_Status_Login = "10";// 消息通知
    ...
    public static final String FILE_APPLYFILE_YTJ = "3"; // 一体机申报材料
     ...
     * 导服工单状态
     */
    public static final String WORKORDER_INIT = "0";// 待签收
    public static final String WORKORDER_Processing = "1"; // 处理中
    public static final String WORKORDER_Processed = "2"; // 处理完成
    public static final String WORKORDER_Invalid = "3"; // 废弃

    /**
     * 取流方式 海康ISC平台
     */
    public static final String STREAM_FROM_ISC = "0";
    /**
     * 取流方式 大华DSS平台
     */
    public static final String STREAM_FROM_DSS = "1";
    /**
     * 取流方式 海康摄像头、NVR
     */
    public static final String STREAM_FROM_HIK = "2";
    /**
     * 取流方式 大华摄像头、NVR
     */
    public static final String STREAM_FROM_DAHUA = "3";

    /**
     * 播放方式 flv
     */
    public static final String STREAM_PLAY_FLV = "0";
    /**
     * 播放方式 hls
     */
    public static final String STREAM_PLAY_HLS = "1";
    /**
     * 播放方式 其他
     */
    public static final String STREAM_PLAY_OTHERS = "2";

    /**
     * 成功
     */
    public static final String COMMON_RETURN_SUCCESS = "success";
    /**
     * 推流状态码
     */
    public static final String STREAMPUSH_STATUS_ERROR = "-1"; // 异常
    public static final String STREAMPUSH_STATUS_SUCCESS = "3"; // 正常可以立即播放
    public static final String STREAMPUSH_STATUS_LIMIT = "80"; // 已达上限
    public static final String STREAMPUSH_STATUS_LOADING = "1"; // 激活拉起状态
    public static final String STREAMPUSH_STATUS_PENDING = "pending"; // 15秒限制
    ...
    public enum PersontrailOptType
    {
        摄像头识别("1"), 取号机取号("2"), 取预约号("3"), 自助申报("4"), 办事预约("5");

        public String value;

        PersontrailOptType(String s) {
            value = s;
        }
    }
}
