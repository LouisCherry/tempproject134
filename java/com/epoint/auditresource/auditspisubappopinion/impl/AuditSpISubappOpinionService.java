 ...
 */
public class AuditSpISubappOpinionService
{
 /**
     * 数据增删改查组件
     */
    ...
    public AuditSpISubappOpinionService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditSpISubappOpinion.class, guid);
    ...
    public AuditSpISubappOpinion find(Object primaryKey) {
        return baseDao.find(AuditSpISubappOpinion.class, primaryKey);
    }
    ...
    public AuditSpISubappOpinion find(String sql,  Object... args) {
        return baseDao.find(sql, AuditSpISubappOpinion.class, args);
    }
    ...
    public List<AuditSpISubappOpinion> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditSpISubappOpinion.class, args);
    }
    ...
    public List<AuditSpISubappOpinion> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditSpISubappOpinion.class, args);
    }
