...
public class ProjectAuthorizationServiceImpl implements IProjectAuthorizationService
{
    ...
    public int insert(ProjectAuthorization record) {
        return new ProjectAuthorizationService().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new ProjectAuthorizationService().deleteByGuid(guid);
    }
    ...
    public int update(ProjectAuthorization record) {
        return new ProjectAuthorizationService().update(record);
    }
    ...
    public ProjectAuthorization find(Object primaryKey) {
       return new ProjectAuthorizationService().find(primaryKey);
    }
    ...
    public ProjectAuthorization find(String sql, Object... args) {
        return new ProjectAuthorizationService().find(sql,args);
    }
    ...
    public List<ProjectAuthorization> findList(String sql, Object... args) {
       return new ProjectAuthorizationService().findList(sql,args);
    }
    ...
    public List<ProjectAuthorization> findList(String sql, int pageNumber, int pageSize, Object... args) {
       return new ProjectAuthorizationService().findList(sql,pageNumber,pageSize,args);
    }
    ...
    public Integer countProjectAuthorization(String sql, Object... args){
        return new ProjectAuthorizationService().countProjectAuthorization(sql, args);
    }

    @Override
    public int deleteByProjectId(String projectId) {
        return new ProjectAuthorizationService().deleteByProjectId(projectId);
    }

    @Override
    public List<String> getUsersByProjectId(String projectId) {
        return new ProjectAuthorizationService().getUsersByProjectId(projectId);
    }
    ...
    public PageData<ProjectAuthorization> getListPage(Map<String, String> conditionMap, int first, int pageSize, String sortField, String sortOrder)  {
        return new SQLManageUtil().getDbListByPage(ProjectAuthorization.class, conditionMap, first, pageSize, sortField, sortOrder);
    }

    public List<String> getUserNamesByProjectId(String projectId) {
        return new ProjectAuthorizationService().getUserNamesByProjectId(projectId);
    }
}
