...
/**
 * 
 *  [一件事统计报表对应的service实现类] 
 * @author 28101
 * @version [版本号, 2022年10月24日]
 */
@Component
public class AnaYjsTjbbServiceImpl implements IAnaYjsTjbb
{
    ...
    public List<Record> getList(int first, int pageSize, String startDate, String endDate,String areacode, String applyerway) {
        return new AnaYjsTjbbService().getList(first, pageSize, startDate, endDate, areacode, applyerway);  
    }
    ...
    public List<Record> getAreaList() {
        return new AnaYjsTjbbService().getAreaList();
    }
    ...
    public int countList(int first, int pageSize, String startDate, String endDate, String areacode,
            String applyerway) {
        return new AnaYjsTjbbService().countList(first, pageSize, startDate, endDate, areacode, applyerway);
    }
