 ...
 */
public class AuditznsbwaterService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(Auditznsbwater.class, guid);
    ...
    public Auditznsbwater find(Object primaryKey) {
        return baseDao.find(Auditznsbwater.class, primaryKey);
    }
    ...
    public Auditznsbwater find(String sql,  Object... args) {
        return baseDao.find(sql, Auditznsbwater.class, args);
    }
    ...
    public List<Auditznsbwater> findList(String sql, Object... args) {
        return baseDao.findList(sql, Auditznsbwater.class, args);
    }
    ...
    public List<Auditznsbwater> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, Auditznsbwater.class, args);
    }
