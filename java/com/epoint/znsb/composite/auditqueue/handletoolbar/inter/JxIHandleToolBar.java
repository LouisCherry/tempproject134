package com.epoint.znsb.composite.auditqueue.handletoolbar.inter;

import com.alibaba.dubbo.config.annotation.Service;
import com.epoint.common.service.AuditCommonResult;

@Service
public interface JxIHandleToolBar {
	 ...
	 *  @return
	 */
    public AuditCommonResult<String> nextPassQueue(String QNO, String passQNO, String windowGuid, String windowNo,String centerGuid,String userGuid);

    /**
     * 
     *  页面关闭（退出登录）执行窗口屏信息的更新
     *  @param windowGuid
     *  @param centerGuid
     *  @return    
     * 
