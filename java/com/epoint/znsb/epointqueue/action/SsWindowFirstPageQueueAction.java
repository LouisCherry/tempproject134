package com.epoint.znsb.epointqueue.action;
...
@RestController("sswindowfirstpagequeueaction")
@Scope("request")
public class SsWindowFirstPageQueueAction extends BaseController {
        ...
        if (StringUtil.isNotBlank(MacAddress)) {
            ...
            if ("status=0".equals(url)) {
                ...
                if (StringUtil.isNotBlank(url)) {
                    redirect("jiningzwfw/individuation/370831000000/epointqueue/wait/" + url);
                } else {
