...
import com.epoint.common.services.SqlParserService;
 ...
 */
public class ExpertIRuleService
{
    /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(ExpertIRule.class, guid);
    ...
    public ExpertIRule find(Object primaryKey) {
        return baseDao.find(ExpertIRule.class, primaryKey);
    }
    ...
    public ExpertIRule find(String sql, Object... args) {
        return baseDao.find(sql, ExpertIRule.class, args);
    }
    ...
    public List<ExpertIRule> findList(String sql, Object... args) {
        return baseDao.findList(sql, ExpertIRule.class, args);
    }
    ...
    public List<ExpertIRule> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, ExpertIRule.class, args);
    }
    ...
    public List<ExpertIRule> findListByCondition(Map<String, String> conditionMap) {
        return DBServcie.getInstance().getListByCondition(ExpertIRule.class, conditionMap);
    }
    ...
    public void deleteObjectByInstanceguid(String instanceGuid, String objectType) {
        String sql = "delete from expert_i_rule where instanceguid=? and objecttype=? ";
        baseDao.execute(sql, instanceGuid, objectType);
    }
}
