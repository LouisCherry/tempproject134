...
/**
 * 专家抽取短信发送表对应的后台service
 * 
 * @author Lee
 * @version [版本号, 2019-08-21 15:42:10]
 */
public class ExpertISmsService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(ExpertISms.class, guid);
    ...
    public ExpertISms find(Object primaryKey) {
        return baseDao.find(ExpertISms.class, primaryKey);
    }
    ...
    public ExpertISms find(String sql,  Object... args) {
        return baseDao.find(sql, ExpertISms.class, args);
    }
    ...
    public List<ExpertISms> findList(String sql, Object... args) {
        return baseDao.findList(sql, ExpertISms.class, args);
    }
    ...
    public List<ExpertISms> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, ExpertISms.class, args);
    }
