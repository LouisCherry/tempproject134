...
public class ItemPlanService {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(ItemPlan.class, guid);
    ...
    public ItemPlan find(Object primaryKey) {
        return baseDao.find(ItemPlan.class, primaryKey);
    }
    ...
    public ItemPlan find(String sql, Object... args) {
        return baseDao.find(sql, ItemPlan.class, args);
    }
    ...
    public List<ItemPlan> findList(String sql, Object... args) {
        return baseDao.findList(sql, ItemPlan.class, args);
    }
    ...
    public List<ItemPlan> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, ItemPlan.class, args);
    }
