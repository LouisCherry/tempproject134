...
public class AuditSpYyyzMaterialServiceImpl implements IAuditSpYyyzMaterialService
{
    ...
    public List<Record> getAuditTaskByCommonTask(String condition) {
        ...
        return new AuditSpYyyzMaterialService().getAuditTaskByCommonTask(condition);
    }

    @Override
    public List<FrameOu> getCommonFrameOuByOuguids(String ouguids) {
        
        return new AuditSpYyyzMaterialService().getCommonFrameOuByOuguids(ouguids);
    }

    @Override
    public List<AuditTask> selectAuditTaskOuByObjectGuid(String ouguid, String areacodes) {
        return new AuditSpYyyzMaterialService().selectAuditTaskOuByObjectGuid(ouguid,areacodes);
    }
    @Override
    public List<AuditTask> selectAuditTaskOuByObjectGuids(String ouguid, String areacodes) {
        return new AuditSpYyyzMaterialService().selectAuditTaskOuByObjectGuids(ouguid,areacodes);
    }
