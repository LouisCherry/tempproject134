 ...
 */
public class BusinessLicenseResultService
{
    ...
    public BusinessLicenseResultService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(BusinessLicenseResult.class, guid);
    ...
    public BusinessLicenseResult find(Object primaryKey) {
        return baseDao.find(BusinessLicenseResult.class, primaryKey);
    }
    ...
    public BusinessLicenseResult find(String sql, Object... args) {
        return baseDao.find(sql, BusinessLicenseResult.class, args);
    }
    ...
    public List<BusinessLicenseResult> findList(String sql, Object... args) {
        return baseDao.findList(sql, BusinessLicenseResult.class, args);
    }
    ...
    public List<BusinessLicenseResult> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, BusinessLicenseResult.class, args);
    }
