package com.epoint.yyyz.auditsptask.action;
 ...
 */
@RestController("yzuditsptaskconfigaction")
@Scope("request")
@SuppressWarnings("serial")
public class YzAuditSpTaskConfigAction extends BaseController
{
    /**
     * 
     */
                    ...
                    if (StringUtil.isNotBlank(phaseguid)) {
                        for (int i = 0; i < basetaskguids.length; i++) {
                            ...
                            if(ZwfwConstant.CONSTANT_STR_TWO.equals(AuditSpBusiness.getBusinesstype())
                            		...
                            		|| "6".equals(AuditSpBusiness.getBusinesstype())){
