 ...
 */
@RestController("certinfoedityyyzaction")
@Scope("request")
public class CertInfoEditYyyzAction extends BaseController
{
     ...
     * 日志
     */
    private Logger log = LogUtil.getLog(CertInfoEditYyyzAction.class);
