package com.epoint.jiningzwfw.projectstatistics.projectdaysperou.api;
...
/**
 * 每日部门办件统计分析表对应的后台service接口
 * 
 * @author yangyi
 * @version [版本号, 2021-06-30 17:37:23]
 */
public interface IAuditOuProjectDaysService extends Serializable
{ 
    ...
    AuditCommonResult<List<AuditOuProjectDays>> findListByCondition(Map<String, String> map);
}
