package com.epoint.jiningzwfw.projectstatistics.projecttaskr.api;
...
/**
 * 每日办件事项记录表对应的后台service接口
 * 
 * @author yangyi
 * @version [版本号, 2021-07-01 09:24:03]
 */
public interface IProjectTaskRService extends Serializable
{ 
    ...
    AuditCommonResult<List<ProjectTaskR>> findListByCondition(Map<String, String> map);
}
