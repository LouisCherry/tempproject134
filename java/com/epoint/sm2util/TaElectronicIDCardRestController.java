...
public class TaElectronicIDCardRestController
{
    ...
    private String privatekey = "00DE243AA05CCBC75F5DDCE56294184093AED8B3C3249F29715563BDB5A1E5DFD1";
    private String accessId = "2c9af5284d39418f9d92093ec53ef0f5";
    private String accessToken = "5d1e0ff58fde411ea5ff1200802a33dc";
    //接口记录日志的注入信息
   ...
   /* @RequestMapping(value = "/getcardinfo", method = RequestMethod.POST)
    public String getcardinfo(@RequestBody String params, @Context HttpServletRequest request) {
        try {
            ...
            String postreason ="{\"head\":{\"accessId\":\""+accessId+"\",\"accessToken\":\""+accessToken+"\"},\"data\":{\"qrcode\":\""+qrcode+"\", \"useCause\":\"济宁政务服务\" }}";
            String httpUrl = "http://59.206.216.230:18883/CertShare/queryCertInfoByQRcode";
            ...
            if("0".equals(headjson.getString("status"))){
                ...
                String getpdfreason ="{\"head\": {\"accessId\": \""+accessId+"\",\"accessToken\": \""+accessToken+"\"},\"data\": {\"certIdentifier\": \""+cert_identifier+"\",\"useCause\": \"\",\"expiryTime\": \"\"}}";
