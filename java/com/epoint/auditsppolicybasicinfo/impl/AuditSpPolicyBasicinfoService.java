 ...
 */
public class AuditSpPolicyBasicinfoService
{
    /**
     * 数据增删改查组件
     */
    ...
    public AuditSpPolicyBasicinfoService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditSpPolicyBasicinfo.class, guid);
    ...
    public AuditSpPolicyBasicinfo find(Object primaryKey) {
        return baseDao.find(AuditSpPolicyBasicinfo.class, primaryKey);
    }
    ...
    public AuditSpPolicyBasicinfo find(String sql, Object... args) {
        return baseDao.find(sql, AuditSpPolicyBasicinfo.class, args);
    }
    ...
    public List<AuditSpPolicyBasicinfo> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditSpPolicyBasicinfo.class, args);
    }
    ...
    public List<AuditSpPolicyBasicinfo> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditSpPolicyBasicinfo.class, args);
    }
    ...
    public List<AuditSpPolicyBasicinfo> getAuditSpPolicyListByCondition(Map<String, String> conditionMap) {
        ...
        String allSql = sqlManageUtil.buildSqlComoplete(AuditSpPolicyBasicinfo.class, conditionMap);       
        return baseDao.findList(allSql, AuditSpPolicyBasicinfo.class);
    }
}
