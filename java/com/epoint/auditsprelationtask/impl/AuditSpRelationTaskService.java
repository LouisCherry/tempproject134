...
/**
 * 前四阶段事项关系表对应的后台service
 * 
 * @author lzhming
 * @version [版本号, 2023-03-17 09:13:27]
 */
public class AuditSpRelationTaskService
{
    /**
     * 数据增删改查组件
     */
    ...
    public AuditSpRelationTaskService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditSpRelationTask.class, guid);
    ...
    public AuditSpRelationTask find(Object primaryKey) {
        return baseDao.find(AuditSpRelationTask.class, primaryKey);
    }
    ...
    public AuditSpRelationTask find(String sql, Object... args) {
        return baseDao.find(sql, AuditSpRelationTask.class, args);
    }
    ...
    public List<AuditSpRelationTask> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditSpRelationTask.class, args);
    }
    ...
    public List<AuditSpRelationTask> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditSpRelationTask.class, args);
    }
    ...
    public List<AuditSpRelationTask> getAuditSpRelationTaskListByCondition(Map<String, String> conditionMap) {
        ...
        String allSql = sqlManageUtil.buildSqlComoplete(AuditSpRelationTask.class, conditionMap);       
        return baseDao.findList(allSql, AuditSpRelationTask.class);
    }
}
