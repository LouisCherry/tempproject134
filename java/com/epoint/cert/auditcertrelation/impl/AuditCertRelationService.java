 ...
 */
public class AuditCertRelationService
{
 /**
     * 数据增删改查组件
     */
    ...
    public AuditCertRelationService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditCertRelation.class, guid);
    ...
    public AuditCertRelation find(Object primaryKey) {
        return baseDao.find(AuditCertRelation.class, primaryKey);
    }
    ...
    public AuditCertRelation find(String sql,  Object... args) {
        return baseDao.find(sql, AuditCertRelation.class, args);
    }
    ...
    public List<AuditCertRelation> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditCertRelation.class, args);
    }
    ...
    public List<AuditCertRelation> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditCertRelation.class, args);
    }
