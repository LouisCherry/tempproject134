...
import com.epoint.cert.basic.certcatalog.areacertcatalog.catalogaudit.CertCatalogAuditAction;
import com.epoint.cert.basic.certcatalog.areacertcatalog.domain.CertCatalog;
import com.epoint.core.utils.string.StringUtil;
import org.springframework.context.annotation.Scope;
import org.springframework.web.bind.annotation.RestController;

@RestController("gxhcertcatalogauditaction")
@Scope("request")
public class GxhCertCatalogAuditAction extends CertCatalogAuditAction {
    /**
     * 数据表清单实体对象
     */
