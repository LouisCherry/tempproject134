...
@Component
@Service
public class AuditSpParallelTaskServiceImpl implements IAuditSpParallelTaskService
{
    /**
     * 插入数据
     * 
    ...
    public int insert(AuditSpParallelTask record) {
        return new AuditSpParallelTaskService().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new AuditSpParallelTaskService().deleteByGuid(guid);
    }
    ...
    public int update(AuditSpParallelTask record) {
        return new AuditSpParallelTaskService().update(record);
    }
    ...
    public AuditSpParallelTask find(Object primaryKey) {
        return new AuditSpParallelTaskService().find(primaryKey);
    }
    ...
    public AuditSpParallelTask find(String sql, Object... args) {
        return new AuditSpParallelTaskService().find(sql, args);
    }
    ...
    public List<AuditSpParallelTask> findList(String sql, Object... args) {
        return new AuditSpParallelTaskService().findList(sql, args);
    }
    ...
    public List<AuditSpParallelTask> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return new AuditSpParallelTaskService().findList(sql, pageNumber, pageSize, args);
    }
    ...
    public Integer countAuditSpParallelTask(String sql, Object... args) {
        return new AuditSpParallelTaskService().countAuditSpParallelTask(sql, args);
    }
    ...
    public List<AuditSpParallelTask> getAuditSpParallelTaskListByCondition(Map<String, String> conditionMap) {        
        return new AuditSpParallelTaskService().getAuditSpParallelTaskListByCondition(conditionMap);
    }
}
