 ...
 * 
 * @author panshunxing
 * @version [版本号, 2024-09-20 03:15:14]
 */
@RestController("kanyanprojectworkflowtabsaction")
@Scope("request")
public class KanyanprojectWorkFlowTabsAction extends WorkflowBaseController
{
    ...
    // 数据表名
    private String sqlTableName = "KANYANPROJECT";
