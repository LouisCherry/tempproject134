 ...
 */
@RestController("certinfoaddzzlbaction")
@Scope("request")
public class CertInfoAddZzlbAction extends BaseController
{
     ...
     * 日志
     */
    private Logger log = LogUtil.getLog(CertInfoAddZzlbAction.class);
...
//            }
    ...
    public FileUploadModel9 getCertFileUploadModel() {
        if (certCatalog != null && certFileUploadModel == null && StringUtil.isNotBlank(certinfo.getCertcliengguid())) {
            ...
            String certcliengguid = certinfo.getCertcliengguid();
            certFileUploadModel = new FileUploadModel9(new DefaultFileUploadHandlerImpl9(certcliengguid,
