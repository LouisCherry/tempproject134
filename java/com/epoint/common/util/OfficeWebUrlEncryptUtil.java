...
public class OfficeWebUrlEncryptUtil
{
    public static String getEncryptUrl(String downloadUrl, String fType) {
        ...
        if (Arrays.asList(contenttype).contains(fType) || "pic".equals(fType)) {
            return downloadUrl;
        }
