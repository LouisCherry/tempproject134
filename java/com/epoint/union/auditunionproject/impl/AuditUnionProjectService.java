...
/**
 * 异地通办办件信息表对应的后台service
 * 
 * @author zhaoyan
 * @version [版本号, 2020-03-22 11:18:36]
 */
public class AuditUnionProjectService
{
 /**
     * 数据增删改查组件
     */
    ...
    public AuditUnionProjectService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditUnionProject.class, guid);
    ...
    public AuditUnionProject find(Object primaryKey) {
        return baseDao.find(AuditUnionProject.class, primaryKey);
    }
    ...
    public AuditUnionProject find(String sql,  Object... args) {
        return baseDao.find(sql, AuditUnionProject.class, args);
    }
    ...
    public List<AuditUnionProject> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditUnionProject.class, args);
    }
    ...
    public List<AuditUnionProject> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditUnionProject.class, args);
    }
