 ...
 */
public class TsuImportInfoService
{
    /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(TsuImportInfo.class, guid);
    ...
    public TsuImportInfo find(Object primaryKey) {
        return baseDao.find(TsuImportInfo.class, primaryKey);
    }
    ...
    public TsuImportInfo find(String sql, Object... args) {
        return baseDao.find(sql, TsuImportInfo.class, args);
    }
    ...
    public List<TsuImportInfo> findList(String sql, Object... args) {
        return baseDao.findList(sql, TsuImportInfo.class, args);
    }
    ...
    public List<TsuImportInfo> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, TsuImportInfo.class, args);
    }
