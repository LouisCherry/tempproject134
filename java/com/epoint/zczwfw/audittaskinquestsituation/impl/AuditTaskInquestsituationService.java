 ...
 */
public class AuditTaskInquestsituationService
{
    /**
     * 数据增删改查组件
     */
    ...
    public AuditTaskInquestsituationService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditTaskInquestsituation.class, guid);
    ...
    public AuditTaskInquestsituation find(Object primaryKey) {
        return baseDao.find(AuditTaskInquestsituation.class, primaryKey);
    }
    ...
    public AuditTaskInquestsituation find(String sql, Object... args) {
        return baseDao.find(sql, AuditTaskInquestsituation.class, args);
    }
    ...
    public List<AuditTaskInquestsituation> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditTaskInquestsituation.class, args);
    }
    ...
    public List<AuditTaskInquestsituation> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditTaskInquestsituation.class, args);
    }
    ...
    public void deleteByTaskGuid(String taskGuid) {
        String sql = "delete from audit_task_inquestsituation where taskguid= ? ";
        baseDao.execute(sql, taskGuid);
    }
    ...
    public List<AuditTaskInquestsituation> listAuditTaskInquestsituationByTaskGuid(String fields, String taskGuid) {
        if (StringUtil.isNotBlank(fields)) {
            String sql = "select " + fields + " from audit_task_inquestsituation where taskguid= ? ";
            return baseDao.findList(sql, AuditTaskInquestsituation.class, taskGuid);
        }
        String sql = "select *  from audit_task_inquestsituation where taskguid= ?";
        return baseDao.findList(sql, AuditTaskInquestsituation.class, taskGuid);
    }
    ...
    public void updateNewTaskGuidByOldTaskGuid(String oldTaskGuid, String newtaskGuid) {
        String sql = "UPDATE audit_task_inquestsituation SET taskguid = ? WHERE taskguid = ? ";
        baseDao.execute(sql, newtaskGuid, oldTaskGuid);
    }
}
