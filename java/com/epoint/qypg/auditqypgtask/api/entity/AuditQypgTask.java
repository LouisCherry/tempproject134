package com.epoint.qypg.auditqypgtask.api.entity;
 ...
 * @作者 ysai
 */
@Entity(table = "audit_qypg_task", id = "rowguid")
public class AuditQypgTask extends BaseEntity implements Cloneable {
