...
public class TsProjectService
{
 /**
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(TsProject.class, guid);
    ...
    public TsProject find(Object primaryKey) {
        return baseDao.find(TsProject.class, primaryKey);
    }
    ...
    public TsProject find(String sql,  Object... args) {
        return baseDao.find(sql, TsProject.class, args);
    }
    ...
    public List<TsProject> findList(String sql, Object... args) {
        return baseDao.findList(sql, TsProject.class, args);
    }
    ...
    public List<TsProject> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, TsProject.class, args);
    }
