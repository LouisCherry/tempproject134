 ...
 */
@RestController("tsprojectlistaction")
@Scope("request")
public class TsProjectListAction  extends BaseController
{
	@Autowired
        ...
        if (model == null) {
            model = new DataGridModel<TsProject>()
            {
                ...
                public List<TsProject> fetchData(int first, int pageSize, String sortField, String sortOrder) {
                    ...
                    int count = service.findList(ListGenerator.generateSql("ts_project", conditionSql, sortField, sortOrder), 
