package com.epoint.cs.yyzzprint.api;
import java.io.Serializable;
import java.util.List;
import com.epoint.cs.yyzzprint.api.entity.Yyzzprint;

/**
 * 营业执照打印记录表对应的后台service接口
 * 
 * @author admin
 * @version [版本号, 2020-04-23 11:25:13]
 */
public interface IYyzzprintService extends Serializable
{ 
    ...
    int getPrintCount(String idnum);

    Yyzzprint getPrint(String idnum);

    Yyzzprint getPrintdeatil(String idnum);
}
