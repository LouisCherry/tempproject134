 ...
 */
public class AuditDmvTaskService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditDmvTask.class, guid);
    ...
    public AuditDmvTask find(Object primaryKey) {
        return baseDao.find(AuditDmvTask.class, primaryKey);
    }
    ...
    public AuditDmvTask find(String sql,  Object... args) {
        return baseDao.find(sql, AuditDmvTask.class, args);
    }
    ...
    public List<AuditDmvTask> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditDmvTask.class, args);
    }
    ...
    public List<AuditDmvTask> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditDmvTask.class, args);
    }
