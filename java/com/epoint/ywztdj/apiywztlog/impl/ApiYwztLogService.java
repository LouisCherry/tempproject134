 ...
 */
public class ApiYwztLogService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(ApiYwztLog.class, guid);
    ...
    public ApiYwztLog find(Object primaryKey) {
        return baseDao.find(ApiYwztLog.class, primaryKey);
    }
    ...
    public ApiYwztLog find(String sql,  Object... args) {
        return baseDao.find(sql, ApiYwztLog.class, args);
    }
    ...
    public List<ApiYwztLog> findList(String sql, Object... args) {
        return baseDao.findList(sql, ApiYwztLog.class, args);
    }
    ...
    public List<ApiYwztLog> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, ApiYwztLog.class, args);
    }
