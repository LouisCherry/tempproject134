package com.epoint.basic.auditqueue.auditznsbremotehelp.inter;
 ...
 */
public interface IAuditZnsbRemoteHelpService extends Serializable
{ 
     ...
     * @see [类、类#方法、类#成员]
     */
    public AuditCommonResult<PageData<AuditZnsbRemoteHelp>> getFileByPage(Map<String, String> conditionMap,
     ...
     * @return
     */
    public AuditCommonResult<AuditZnsbRemoteHelp> getDetailByAioRowguid(String aioRowGuid);
    ...
    public Integer getAuditZnsbRemoteHelpName(String username);
