 ...
 */
public class DataassetsExportDetailService
{
 /**
     * 数据增删改查组件
     */
    ...
    public DataassetsExportDetailService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(DataassetsExportDetail.class, guid);
    ...
    public DataassetsExportDetail find(Object primaryKey) {
        return baseDao.find(DataassetsExportDetail.class, primaryKey);
    }
    ...
    public DataassetsExportDetail find(String sql,  Object... args) {
        return baseDao.find(sql, DataassetsExportDetail.class, args);
    }
    ...
    public List<DataassetsExportDetail> findList(String sql, Object... args) {
        return baseDao.findList(sql, DataassetsExportDetail.class, args);
    }
    ...
    public List<DataassetsExportDetail> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, DataassetsExportDetail.class, args);
    }
    ...
    public List<DataassetsExportDetail> findListByExportguid(String exportguid) {
        String sql = "select * from dataassets_export_detail where exportguid = ?";
        return baseDao.findList(sql, DataassetsExportDetail.class, exportguid);
    }
	public Record getEvaDetail(String codeid) {
		String sql = "SELECT itemtext from Code_Items where CODEID='1016203' and ITEMVALUE=? ";
		return baseDao.find(sql,Record.class, codeid);
	}
}
