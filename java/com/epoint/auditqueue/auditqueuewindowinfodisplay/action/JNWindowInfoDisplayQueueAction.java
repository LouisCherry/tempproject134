...
@RestController("jnwindowinfodisplayqueueaction")
@Scope("request")
public class JNWindowInfoDisplayQueueAction extends BaseController
{
    ...
    public void pageLoad() {
        addCallbackParam("html", getWindowTask(getRequestParameter("windowguid")));
    }
