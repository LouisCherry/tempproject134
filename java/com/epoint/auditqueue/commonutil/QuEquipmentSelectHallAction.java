...
@RestController("QuEquipmentSelectHallAction")
@Scope("request")
public class QuEquipmentSelectHallAction extends BaseController {
	/**
	 * 
	 */
	...
	private SimpleFetchHandler9 loadAllTask() {
		SimpleFetchHandler9 fetchHandler9 = new SimpleFetchHandler9() {
			...
			public List<AuditOrgaHall> selectTasktypeByCondition(String condition) {
				...
				s.put("Centerguid=", "4391ec2f-6903-4a1a-af2d-6ba281bc5884");
	...
	public List<SelectItem> getSelectTasktype(String windowGuid) {
		...
		if (StringUtil.isNotBlank(windowGuid)) {
			...
			if (StringUtil.isNotBlank(windowGuid)) {
			    String hallguid =   equipmentservice.getEquipmentByRowguid(windowGuid).getResult().getStr("quhallguid");
