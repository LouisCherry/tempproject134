...
public class TAHandleProjectImpl implements ITAHandleProject
{
    public AuditCommonResult<String> InitProject(String taskGuid, String projectGuid, String operateUserName,
        ...
        try {
            String rowGuid = (String) this.InitProject(taskGuid, projectGuid, operateUserName, operateUserGuid,
                    windowGuid, windowName, centerGuid, certNum, qno, acceptareacode, cityLevel, "").getResult();
...
//            }
    ...
    public AuditCommonResult<String> InitIntegratedProject(String taskGuid, String projectGuid, String operateUserName,
        ...
        try {
            ...
            auditproject.setFlowsn((String) flowSn.getFlowsn("办件编号", numberFlag).getResult());*/

            String operateusername = new TAHandleProjectService().getOperateUsername(auditproject.getTaskguid());
            ...
            if (serviceType.equals(operateusername)) {
               ...
               /* String areaCode = auditTask.getAreacode();
                ...
                /*String numberFlag = handleConfig.getFrameConfig("AS_FLOWSN_PRE", auditproject.getCenterguid())
                        .getResult();
                if (StringUtil.isBlank(numberFlag)) {
                    numberFlag = "STD";
                }*/
    ...
    public AuditCommonResult<String> InitProject(String taskGuid, String projectGuid, String operateUserName,
        ...
        try {
            ...
            if (Integer.parseInt(cityLevel) > Integer.parseInt("2") || "40".equals(delegatetype)) {
            ...
            List<AuditTaskMaterial> auditTaskMaterials = (List) auditTaskMaterialService
                    ...
                    .getResult();
            AuditProjectMaterial auditProjectMaterial = new AuditProjectMaterial();
            Iterator var23 = auditTaskMaterials.iterator();

            while (var23.hasNext()) {
                AuditTaskMaterial auditTaskMaterial = (AuditTaskMaterial) var23.next();
                auditProjectMaterial.clear();
                auditProjectMaterial.setRowguid(UUID.randomUUID().toString());
                auditProjectMaterial.setTaskguid(auditTask.getRowguid());
                auditProjectMaterial.setProjectguid(auditproject.getRowguid());
