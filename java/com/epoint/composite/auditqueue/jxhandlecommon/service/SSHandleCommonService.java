package com.epoint.composite.auditqueue.jxhandlecommon.service;
...
public class SSHandleCommonService
{
    ...
    IAuditOrgaArea orgaareaservice = ContainerFactory.getContainInfo().getComponent(IAuditOrgaArea.class);
    ...
    public void SendQueueMessage(String QNO, String WindowGuid, String CenterGuid, String WindowNo) {
        ...
        if (StringUtil.isNotBlank(Phone)) {
            ...
            if (StringUtil.isNotBlank(messagecontent)) {
                if ("7b138bdc-a7cb-4dad-9e03-f8b29410a27a".equals(CenterGuid)) {
                    messageservice.insertSmsMessage(UUID.randomUUID().toString(), messagecontent, new Date(), 0, null,
                            Phone, UUID.randomUUID().toString(), "", "", "", "", "", null, false, "370831");
                }
                else {
                    messageservice.insertSmsMessage(UUID.randomUUID().toString(), messagecontent, new Date(), 0, null,
                            Phone, UUID.randomUUID().toString(), "", "", "", "", "", null, false, belongxiaqu);
                }
            }
        }
