...
public class EpointSynProjectService {
    ...
    public EpointSynProjectService() {
    ...
    public List<Record> getProjectList(String condition) {
        String sql = "select * from pre_project where synid='I' " + condition + " limit 100";
        return commonDaoFrom.findList(sql, Record.class);
    }

    public List<Record> getProjectListone() {
        String sql = "select * from pre_project where synid='U' and DATE_FORMAT(protime,'%Y-%m-%d') >= '2020-10-01' limit 10";
        return commonDaoFrom.findList(sql, Record.class);
    }
