...
@Deprecated
public class ProjectdownForLCZJ implements Job
{
    transient Logger log = LogUtil.getLog(ProjectdownForLCZJ.class);
    //浪潮前置库有用字段
    ...
    private void syncProjectinfo() {
        ...
        for (Record record : infolist) {
            ...
            String INNERNO = record.getStr("INNERNO");
