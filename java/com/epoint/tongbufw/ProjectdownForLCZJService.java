...
public class ProjectdownForLCZJService
{
    transient Logger log = LogUtil.getLog(ProjectdownForLCZJService.class);
    ...
    public ProjectdownForLCZJService() {
    ...
    public AuditTask gettaskbydeptask(String deptask,String areacode) {
        ...
        return commonDaoTo.find(sql, AuditTask.class, deptask,areacode);
    }
    ...
    public List<Record> getProcFromQzkByProjid(String flowsn){
        String sql = "SELECT * from EA_JC_STEP_PROC "
    ...
    public List<Record> getDoneFromQzkByProjid(String flowsn){
        String sql = "SELECT * from EA_JC_STEP_DONE "
    ...
    public List<Record> getDoneFromQzk(){
        String sql = "SELECT PROJID from EA_JC_STEP_DONE where NVL(gtsync,'0')='0' and rownum <= 20";
