...
public class ProjectdownQt implements Job
{
    transient Logger log = LogUtil.getLog(ProjectdownQt.class);
            ...
            for (AuditProject project : projectList) {
                ...
                if (recordList != null && recordList.size() > 0) {
                    for (Record record : recordList) {
                        ...
                        IAuditOnlineProject auditOnlineProjectService = ContainerFactory.getContainInfo().getComponent(IAuditOnlineProject.class);
