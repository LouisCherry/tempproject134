...
public class AuditProjectFormSgxkzService
{
    ...
    public AuditProjectFormSgxkz find(Object primaryKey) {
        return baseDao.find(AuditProjectFormSgxkz.class, primaryKey);
    }
    ...
    public List<AuditProjectFormSgxkzDanti> findDantiList(int pageNumber, int pageSize, String projectguid) {
        ...
        return baseDao.findList(sql, pageNumber, pageSize, AuditProjectFormSgxkzDanti.class,projectguid);
    }
