package com.epoint.jnzwfw.auditproject.auditprojectformsgxkzdanti.api.entity;
...
public class AuditProjectFormSgxkzDanti extends BaseEntity implements Cloneable
{
     ...
     * 是否超限高层建筑
     */
    public String getISSuperHightBuilding() {
        return super.get("ISSuperHightBuilding");
    }

    public void setISSuperHightBuilding(String ISSuperHightBuilding) {
        super.set("ISSuperHightBuilding", ISSuperHightBuilding);
    }
    
    /**
     * 抗震设防烈度
     */
    public String getSeismicIntensityScale() {
        return super.get("SeismicIntensityScale");
    }

    public void setSeismicIntensityScale(String SeismicIntensityScale) {
        super.set("SeismicIntensityScale", SeismicIntensityScale);
    }
    /**
