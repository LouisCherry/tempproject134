...
@Component
@Service
public class AuditOrgaUserconditionServiceImpl implements IAuditOrgaUserconditionService
{
    /**
     * 
     */
    ...
    public int insert(AuditOrgaUsercondition record) {
        return new AuditOrgaUserconditionService().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new AuditOrgaUserconditionService().deleteByGuid(guid);
    }
    ...
    public int update(AuditOrgaUsercondition record) {
        return new AuditOrgaUserconditionService().update(record);
    }
    ...
    public AuditOrgaUsercondition find(Object primaryKey) {
       return new AuditOrgaUserconditionService().find(primaryKey);
    }
    ...
    public AuditOrgaUsercondition find(String sql, Object... args) {
        return new AuditOrgaUserconditionService().find(args);
    }
    ...
    public List<AuditOrgaUsercondition> findList(String sql, Object... args) {
       return new AuditOrgaUserconditionService().findList(sql,args);
    }
    ...
    public List<AuditOrgaUsercondition> findList(String sql, int pageNumber, int pageSize, Object... args) {
       return new AuditOrgaUserconditionService().findList(sql,pageNumber,pageSize,args);
    }
