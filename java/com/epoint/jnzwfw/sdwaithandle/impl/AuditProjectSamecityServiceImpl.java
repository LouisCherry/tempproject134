...
@Component
@Service
public class AuditProjectSamecityServiceImpl implements IAuditProjectSamecityService
{
    /**
     * 
     */
    ...
    public int insert(AuditProjectSamecity record) {
        return new AuditProjectSamecityService().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new AuditProjectSamecityService().deleteByGuid(guid);
    }
    ...
    public int update(AuditProjectSamecity record) {
        return new AuditProjectSamecityService().update(record);
    }
    ...
    public AuditProjectSamecity find(Object primaryKey) {
        return new AuditProjectSamecityService().find(primaryKey);
    }
    ...
    public AuditProjectSamecity find(String sql, Object... args) {
        return new AuditProjectSamecityService().find(args);
    }
    ...
    public List<AuditProjectSamecity> findList(String sql, Object... args) {
        return new AuditProjectSamecityService().findList(sql, args);
    }
    ...
    public List<AuditProjectSamecity> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return new AuditProjectSamecityService().findList(sql, pageNumber, pageSize, args);
    }
    ...
    public AuditProjectSamecity getProjectSamecityByProjectguid(String projectguid) {
        return new AuditProjectSamecityService().getProjectSamecityByProjectguid(projectguid);
    }
}
