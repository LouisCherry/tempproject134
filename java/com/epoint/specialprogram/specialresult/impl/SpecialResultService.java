...
public class SpecialResultService
{
 /**
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(SpecialResult.class, guid);
    ...
    public SpecialResult find(Object primaryKey) {
        return baseDao.find(SpecialResult.class, primaryKey);
    }
    ...
    public SpecialResult find(String sql,  Object... args) {
        return baseDao.find(sql, SpecialResult.class, args);
    }
    ...
    public List<SpecialResult> findList(String sql, Object... args) {
        return baseDao.findList(sql, SpecialResult.class, args);
    }
    ...
    public List<SpecialResult> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, SpecialResult.class, args);
    }
