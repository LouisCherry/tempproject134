 ...
 */
public class SpecialApplyService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(SpecialApply.class, guid);
    ...
    public SpecialApply find(Object primaryKey) {
        return baseDao.find(SpecialApply.class, primaryKey);
    }
    ...
    public SpecialApply find(String sql,  Object... args) {
        return baseDao.find(sql, SpecialApply.class, args);
    }
    ...
    public List<SpecialApply> findList(String sql, Object... args) {
        return baseDao.findList(sql, SpecialApply.class, args);
    }
    ...
    public List<SpecialApply> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, SpecialApply.class, args);
    }
