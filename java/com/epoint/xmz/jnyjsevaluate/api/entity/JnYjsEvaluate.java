...
public void setAreacode(String  areacode){ super.set("areacode",areacode);} /**
  * 主题标识
  */
  public  String  getBusinessguid(){ return super.get("businessguid");}
public void setBusinessguid(String  businessguid){ super.set("businessguid",businessguid);} /**
  * 主题名称
  */
...
public void setBusinessname(String  businessname){ super.set("businessname",businessname);} /**
  * 标签
  */
  public  String  getLabel(){ return super.get("label");}
public void setLabel(String  label){ super.set("label",label);} /**
  * 理由
  */
  public  String  getReason(){ return super.get("reason");}
public void setReason(String  reason){ super.set("reason",reason);} /**
  * 备注
  */
...
public void setRemark(String  remark){ super.set("remark",remark);} /**
  * 满意度
  */
  public  String  getSatisfaction(){ return super.get("satisfaction");}
public void setSatisfaction(String  satisfaction){ super.set("satisfaction",satisfaction);} /**
  * 默认主键字段
  */
