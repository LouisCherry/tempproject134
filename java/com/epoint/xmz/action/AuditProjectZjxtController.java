...
import com.epoint.xmz.job.SWJZQYDataDjJob;
...
public class AuditProjectZjxtController {
    ...
    @Autowired
    private IJnService iAuditProjectZjxtService;
    @Autowired
    ...
    public  String ReceiveBasicInfo(@RequestBody String params, @Context HttpServletRequest request){
        try {
           ...
           // String token = jsonObject.getString("token");
            ...
            String datasourcessysname = obj.getString("datasourcessysname");
            String systemlevel = obj.getString("systemlevel");
            ...
            //判断事项是否为空
            AuditTask auditBasicInfo = iAuditProjectZjxtService.getAuditBasicInfo(itemname, regionid);
