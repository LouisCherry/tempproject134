 ...
 */
public class GxhImportCertService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(GxhImportCert.class, guid);
    ...
    public GxhImportCert find(Object primaryKey) {
        return baseDao.find(GxhImportCert.class, primaryKey);
    }
    ...
    public GxhImportCert find(String sql,  Object... args) {
        return baseDao.find(sql, GxhImportCert.class, args);
    }
    ...
    public List<GxhImportCert> findList(String sql, Object... args) {
        return baseDao.findList(sql, GxhImportCert.class, args);
    }
    ...
    public List<GxhImportCert> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, GxhImportCert.class, args);
    }
