...
/**
 * 个性化证照导入表对应的后台service
 * 
 * @author dyxin
 * @version [版本号, 2023-06-12 16:30:17]
 */
public class GxhImportCertLsService
{
    /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(GxhImportCertLs.class, guid);
    ...
    public GxhImportCertLs find(Object primaryKey) {
        return baseDao.find(GxhImportCertLs.class, primaryKey);
    }
    ...
    public GxhImportCertLs find(String sql, Object... args) {
        return baseDao.find(sql, GxhImportCertLs.class, args);
    }
    ...
    public List<GxhImportCertLs> findList(String sql, Object... args) {
        return baseDao.findList(sql, GxhImportCertLs.class, args);
    }
    ...
    public List<GxhImportCertLs> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, GxhImportCertLs.class, args);
    }
