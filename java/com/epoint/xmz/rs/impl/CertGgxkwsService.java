package com.epoint.xmz.rs.impl;
...
/**
 * 公共许可卫生证照库对应的后台service
 * 
 * @author 1
 * @version [版本号, 2022-04-12 17:01:05]
 */
public class CertGgxkwsService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(CertGgxkws.class, guid);
    ...
    public CertGgxkws find(Object primaryKey) {
        return baseDao.find(CertGgxkws.class, primaryKey);
    }
    ...
    public CertGgxkws find(String sql,  Object... args) {
        return baseDao.find(sql, CertGgxkws.class, args);
    }
    ...
    public List<CertGgxkws> findList(String sql, Object... args) {
        return baseDao.findList(sql, CertGgxkws.class, args);
    }
    ...
    public List<CertGgxkws> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, CertGgxkws.class, args);
    }
    ...
    public CertGgxkws getCertByCertno(String certno) {
    	String sql = "select * from cert_ggxkws where certno = ? and is_enable = '1'";
        return baseDao.find(sql,CertGgxkws.class, certno);
    }
}
