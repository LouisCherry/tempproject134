...
/**
 * 建设工程质量检测机构资质审批表对应的后台service
 * 
 * @author 86177
 * @version [版本号, 2021-05-08 17:01:26]
 */
public class XmzJsgczljcjgzzspService
{
 /**
     * 数据增删改查组件
     */
    ...
    public XmzJsgczljcjgzzspService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(XmzJsgczljcjgzzsp.class, guid);
    ...
    public XmzJsgczljcjgzzsp find(Object primaryKey) {
        return baseDao.find(XmzJsgczljcjgzzsp.class, primaryKey);
    }
    ...
    public XmzJsgczljcjgzzsp find(String sql,  Object... args) {
        return baseDao.find(sql, XmzJsgczljcjgzzsp.class, args);
    }
    ...
    public List<XmzJsgczljcjgzzsp> findList(String sql, Object... args) {
        return baseDao.findList(sql, XmzJsgczljcjgzzsp.class, args);
    }
    ...
    public List<XmzJsgczljcjgzzsp> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, XmzJsgczljcjgzzsp.class, args);
    }
