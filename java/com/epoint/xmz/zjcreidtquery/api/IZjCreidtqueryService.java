package com.epoint.xmz.zjcreidtquery.api;
...
/**
 * 信用查询调用统计表对应的后台service接口
 * 
 * @author 1
 * @version [版本号, 2021-10-09 14:58:46]
 */
public interface IZjCreidtqueryService extends Serializable
{ 
     ...
     */
	 ...
	 List<Record> finList(int first, int pagesize,  Date starttime, Date endtime,String type, String areacode);
	 
	 
	 Integer finTotal(Date starttime, Date endtime,String type, String areacode);
}
