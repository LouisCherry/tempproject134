package com.epoint.xmz.certczcjsybj.api;
...
/**
 * 出租车驾驶员人员背景明细库对应的后台service接口
 * 
 * @author dyxin
 * @version [版本号, 2023-05-22 13:17:57]
 */
public interface ICertCzcjsybjService extends Serializable
{ 
     ...
     */
	 ...
	 public PageData<CertCzcjsybj> findPageData(Map<String, String> map, int pageNumber, int pageSize,String sortField,String sortOrder);
