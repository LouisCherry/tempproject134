...
/**
 * 出租车驾驶员人员背景明细库对应的后台service
 * 
 * @author dyxin
 * @version [版本号, 2023-05-22 13:17:57]
 */
public class CertCzcjsybjService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(CertCzcjsybj.class, guid);
    ...
    public CertCzcjsybj find(Object primaryKey) {
        return baseDao.find(CertCzcjsybj.class, primaryKey);
    }
    ...
    public CertCzcjsybj find(String sql,  Object... args) {
        return baseDao.find(sql, CertCzcjsybj.class, args);
    }
    ...
    public List<CertCzcjsybj> findList(String sql, Object... args) {
        return baseDao.findList(sql, CertCzcjsybj.class, args);
    }
    ...
    public List<CertCzcjsybj> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, CertCzcjsybj.class, args);
    }
