 ...
 */
public class CertBgxzdjService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(CertBgxzdj.class, guid);
    ...
    public CertBgxzdj find(Object primaryKey) {
        return baseDao.find(CertBgxzdj.class, primaryKey);
    }
    ...
    public CertBgxzdj find(String sql,  Object... args) {
        return baseDao.find(sql, CertBgxzdj.class, args);
    }
    ...
    public List<CertBgxzdj> findList(String sql, Object... args) {
        return baseDao.findList(sql, CertBgxzdj.class, args);
    }
    ...
    public List<CertBgxzdj> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, CertBgxzdj.class, args);
    }
