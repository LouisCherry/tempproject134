...
/**
 * 国土上传预审批复函对应的后台service
 * 
 * @author 1
 * @version [版本号, 2022-10-06 17:34:42]
 */
public class XsYjsfjService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(XsYjsfj.class, guid);
    ...
    public XsYjsfj find(Object primaryKey) {
        return baseDao.find(XsYjsfj.class, primaryKey);
    }
    ...
    public XsYjsfj find(String sql,  Object... args) {
        return baseDao.find(sql, XsYjsfj.class, args);
    }
    ...
    public List<XsYjsfj> findList(String sql, Object... args) {
        return baseDao.findList(sql, XsYjsfj.class, args);
    }
    ...
    public List<XsYjsfj> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, XsYjsfj.class, args);
    }
