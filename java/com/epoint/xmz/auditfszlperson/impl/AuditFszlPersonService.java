 ...
 */
public class AuditFszlPersonService {
    /**
     * 数据增删改查组件
     */
    protected ICommonDao baseDao;

    public AuditFszlPersonService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditFszlPerson.class, guid);
    ...
    public AuditFszlPerson find(Object primaryKey) {
        return baseDao.find(AuditFszlPerson.class, primaryKey);
    }
    ...
    public AuditFszlPerson find(String sql, Object... args) {
        return baseDao.find(sql, AuditFszlPerson.class, args);
    }
    ...
    public List<AuditFszlPerson> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditFszlPerson.class, args);
    }
    ...
    public List<AuditFszlPerson> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditFszlPerson.class, args);
    }
    ...
    public void deleteByFszlguid(String fszlguid) {
        String sql = "delete from audit_fszl_person where fszlguid = ?";
        baseDao.execute(sql,fszlguid);
    }

    public List<AuditFszlPerson> findListByFszlguid(String fszlguid) {
        String sql = "select * from audit_fszl_person where fszlguid = ? ";
        return baseDao.findList(sql, AuditFszlPerson.class, fszlguid);
    }
}
