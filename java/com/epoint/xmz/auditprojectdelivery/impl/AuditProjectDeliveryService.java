 ...
 */
public class AuditProjectDeliveryService {
    /**
     * 数据增删改查组件
     */
    protected ICommonDao baseDao;

    public AuditProjectDeliveryService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditProjectDelivery.class, guid);
    ...
    public AuditProjectDelivery find(Object primaryKey) {
        return baseDao.find(AuditProjectDelivery.class, primaryKey);
    }
    ...
    public AuditProjectDelivery find(String sql, Object... args) {
        return baseDao.find(sql, AuditProjectDelivery.class, args);
    }
    ...
    public List<AuditProjectDelivery> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditProjectDelivery.class, args);
    }
    ...
    public List<AuditProjectDelivery> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditProjectDelivery.class, args);
    }
