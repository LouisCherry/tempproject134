 ...
 */
public class JnTaskRelationService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(JnTaskRelation.class, guid);
    ...
    public JnTaskRelation find(Object primaryKey) {
        return baseDao.find(JnTaskRelation.class, primaryKey);
    }
    ...
    public JnTaskRelation find(String sql,  Object... args) {
        return baseDao.find(sql, JnTaskRelation.class, args);
    }
    ...
    public List<JnTaskRelation> findList(String sql, Object... args) {
        return baseDao.findList(sql, JnTaskRelation.class, args);
    }
    ...
    public List<JnTaskRelation> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, JnTaskRelation.class, args);
    }
