...
/**
 * 自建系统知识库表对应的后台service
 * 
 * @author 1
 * @version [版本号, 2021-10-25 15:12:09]
 */
public class ZjKnowledgeService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(ZjKnowledge.class, guid);
    ...
    public ZjKnowledge find(Object primaryKey) {
        return baseDao.find(ZjKnowledge.class, primaryKey);
    }
    ...
    public ZjKnowledge find(String sql,  Object... args) {
        return baseDao.find(sql, ZjKnowledge.class, args);
    }
    ...
    public List<ZjKnowledge> findList(String sql, Object... args) {
        return baseDao.findList(sql, ZjKnowledge.class, args);
    }
    ...
    public List<ZjKnowledge> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, ZjKnowledge.class, args);
    }
