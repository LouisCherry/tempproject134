...
/**
 * 房地产开发资质证书对应的后台service
 * 
 * @author 86177
 * @version [版本号, 2021-05-12 09:40:37]
 */
public class XmzFdckfzzzsService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(XmzFdckfzzzs.class, guid);
    ...
    public XmzFdckfzzzs find(Object primaryKey) {
        return baseDao.find(XmzFdckfzzzs.class, primaryKey);
    }
    ...
    public XmzFdckfzzzs find(String sql,  Object... args) {
        return baseDao.find(sql, XmzFdckfzzzs.class, args);
    }
    ...
    public List<XmzFdckfzzzs> findList(String sql, Object... args) {
        return baseDao.findList(sql, XmzFdckfzzzs.class, args);
    }
    ...
    public List<XmzFdckfzzzs> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, XmzFdckfzzzs.class, args);
    }
