 ...
 * @author WindowCC
 */
public class JnNoPassClientHandle extends AuditClientMessageListener{
    ...
    public void handleMessage(AuditMqMessage proMessage) throws Exception {
        ...
        IHandleProject handleProject = ContainerFactory.getContainInfo().getComponent(IHandleProject.class);
        ...
        String fields = " rowguid,taskguid,projectname,applyeruserguid,applyername,areacode,pviguid,status,is_pause,hebingshoulishuliang,remark,ouguid,windowguid,biguid,applyway,banjiedate ";
        AuditProject auditProject = auditProjectService.getAuditProjectByRowGuid(fields, projectID, areaCode)
                .getResult();
        handleProject.handleFinish(auditProject, "", "", "");
