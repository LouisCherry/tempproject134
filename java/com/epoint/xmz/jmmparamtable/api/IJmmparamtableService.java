package com.epoint.xmz.jmmparamtable.api;
...
/**
 * 居民码市县参数配置表对应的后台service接口
 *
 * @author Administrator
 * @version [版本号, 2023-06-26 14:34:17]
 */
public interface IJmmparamtableService extends Serializable {
    ...
    Jmmparamtable getJmmParamByAreacode(String areacode);

    Jmmparamtable getJmmParamByCondition(String areacode,String scene);
}
