package com.epoint.xmz.homepagenotice.api;
 ...
 */
public interface IHomepageNoticeService extends Serializable {
     ...
     * @return
     */
    HomepageNotice getHomepage();

    /**
     * 获取最新的公告数据
     * @return
     */
    HomepageNotice getLatestHomepage();
