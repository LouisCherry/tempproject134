...
/**
 * 国土项目基本情况对应的后台service
 * 
 * @author 1
 * @version [版本号, 2022-10-06 15:46:23]
 */
public class XsXmjbqkService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(XsXmjbqk.class, guid);
    ...
    public XsXmjbqk find(Object primaryKey) {
        return baseDao.find(XsXmjbqk.class, primaryKey);
    }
    ...
    public XsXmjbqk find(String sql,  Object... args) {
        return baseDao.find(sql, XsXmjbqk.class, args);
    }
    ...
    public List<XsXmjbqk> findList(String sql, Object... args) {
        return baseDao.findList(sql, XsXmjbqk.class, args);
    }
    ...
    public List<XsXmjbqk> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, XsXmjbqk.class, args);
    }
