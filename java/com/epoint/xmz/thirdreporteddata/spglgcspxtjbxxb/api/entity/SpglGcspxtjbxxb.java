package com.epoint.xmz.thirdreporteddata.spglgcspxtjbxxb.api.entity;
 ...
 * @作者 lzhming
 */
@Entity(table = "SPGL_GCSPXTJBXXB_V3", id = "rowguid")
public class SpglGcspxtjbxxb extends BaseEntity implements Cloneable {
