...
import com.epoint.xmz.thirdreporteddata.spglqypg.spglqypgsxxxb.impl.SpglQypgsxxxbService;
...
public class SpglQypgxxbServiceImpl implements ISpglQypgxxbService {
     ...
     */
    @Override
    public PageData<SpglQypgxxb> getNotAssociationPageData(String itemguid, int firstResult,
                                                           int maxResults, String sortField, String sortOrder) {
        return new SpglQypgxxbService().getNotAssociationPageData(itemguid, firstResult, maxResults, sortField,
                sortOrder);
    }

    @Override
    public List<SpglQypgxxb> getSpglQypgxxbListByitemguid(String rowguid) {
        return new SpglQypgxxbService().getSpglQypgxxbListByitemguid(rowguid);
    }
