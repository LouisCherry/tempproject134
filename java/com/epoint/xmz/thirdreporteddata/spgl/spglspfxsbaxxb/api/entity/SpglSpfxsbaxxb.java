package com.epoint.xmz.thirdreporteddata.spgl.spglspfxsbaxxb.api.entity;
 ...
 * @作者 Administrator
 */
@Entity(table = "SPGL_SPFXSBAXXB", id = "rowguid")
public class SpglSpfxsbaxxb extends BaseEntity implements Cloneable {
