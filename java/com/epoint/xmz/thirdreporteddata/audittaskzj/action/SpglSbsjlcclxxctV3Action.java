...
@RestController("spglsbsjlcclxxctv3action")
@Scope("request")
public class SpglSbsjlcclxxctV3Action extends BaseController
{

    private static final long serialVersionUID = 8796953926146877276L;

    transient Logger log = LogUtil.getLog(SpglSbsjlcclxxctV3Action.class);
    ...
    public void pageLoad() {
        ...
        dataBean = iSpglSpsxclmlxxbService.find(rowguid);
        if (dataBean != null) {
    ...
    public void reSyncBusiness() {
        ...
        try {
            ...
            SpglSpsxclmlxxb oldDataBean = iSpglSpsxclmlxxbService.find(rowguid);
