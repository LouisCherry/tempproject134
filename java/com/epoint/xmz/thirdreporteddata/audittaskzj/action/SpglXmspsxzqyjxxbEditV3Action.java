...
/**
 * 项目审批事项征求意见信息表修改页面对应的后台
 *
 * @author 95453
 * @version [版本号, 2019-06-20 14:31:29]
 */
@RestController("spglxmspsxzqyjxxbeditv3action")
@Scope("request")
public class SpglXmspsxzqyjxxbEditV3Action extends BaseController
{
     ...
     * 实体对象
     */
    private SpglXmspsxzqyjxxbV3 dataBean = null;
    ...
    public void save() {
        ...
        try {
            ...
            SpglXmspsxzqyjxxbV3 oldDataBean = service.find(rowguid);
