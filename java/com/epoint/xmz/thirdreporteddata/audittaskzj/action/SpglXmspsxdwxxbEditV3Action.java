...
/**
 * 项目审批事项责任主体信息表修改页面对应的后台
 *
 * @author 95453
 * @version [版本号, 2019-06-20 14:31:29]
 */
@RestController("spglxmspsxdwxxbeditv3action")
@Scope("request")
public class SpglXmspsxdwxxbEditV3Action extends BaseController
{
     ...
     * 实体对象
     */
    private SpglZrztxxbV3 dataBean = null;
    ...
    public void save() {
        ...
        try {
            ...
            SpglZrztxxbV3 oldDataBean = service.find(rowguid);
