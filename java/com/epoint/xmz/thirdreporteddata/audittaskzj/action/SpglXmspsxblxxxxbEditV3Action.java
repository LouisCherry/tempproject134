 ...
 */
@RightRelation(SpglXmspsxblxxbListV3Action.class)
@RestController("spglxmspsxblxxxxbeditv3action")
@Scope("request")
public class SpglXmspsxblxxxxbEditV3Action extends BaseController
{
    ...
    public void save() {
        ...
        try {
            ...
            SpglXmspsxblxxxxbV3 oldDataBean = service.find(rowguid);
