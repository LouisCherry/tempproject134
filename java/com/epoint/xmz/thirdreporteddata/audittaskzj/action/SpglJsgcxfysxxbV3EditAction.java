...
/**
 * 建设工程消防验收信息表修改页面对应的后台
 *
 * @author Epoint
 * @version [版本号, 2023-11-01 17:19:25]
 */
@RightRelation(com.epoint.xmz.thirdreporteddata.audittaskzj.action.SpglJsgcxfysxxbV3ListAction.class)
@RestController("spgljsgcxfysxxbv3editaction")
@Scope("request")
public class SpglJsgcxfysxxbV3EditAction extends BaseController {
     ...
     * 建设工程消防验收信息表实体对象
     */
    private SpglJsgcxfysxxbV3 dataBean = null;
    ...
    public void save() {
        ...
        try {
            ...
            if (StringUtil.isNotBlank(dataBean.getRowguid())) {
                SpglJsgcxfysxxbV3 oldDataBean = service.findDominByCondition(xzqhdm, gcdm, spsxslbm);
