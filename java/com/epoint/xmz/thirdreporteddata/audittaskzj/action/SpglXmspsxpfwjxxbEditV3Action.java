 ...
 */
@RightRelation(com.epoint.xmz.thirdreporteddata.audittaskzj.action.SpglXmspsxpfwjxxbListV3Action.class)
@RestController("spglxmspsxpfwjxxbeditv3action")
@Scope("request")
public class SpglXmspsxpfwjxxbEditV3Action extends BaseController
{
     ...
     * 实体对象
     */
    private SpglXmspsxpfwjxxbV3 dataBean = null;
    ...
    public void save() {
        ...
        try {
            ...
            SpglXmspsxpfwjxxbV3 oldDataBean = service.find(rowguid);
