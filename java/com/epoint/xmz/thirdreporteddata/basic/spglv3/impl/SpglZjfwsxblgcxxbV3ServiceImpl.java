...
import com.epoint.xmz.thirdreporteddata.basic.spglv3.service.SpglZjfwsxblgcxxbV3Service;
...
@Component
@Service
public class SpglZjfwsxblgcxxbV3ServiceImpl implements ISpglZjfwsxblgcxxbV3Service {
    /**
     * 插入数据
     *
    ...
    public int insert(SpglZjfwsxblgcxxbV3 record) {
        return new SpglZjfwsxblgcxxbV3Service().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new SpglZjfwsxblgcxxbV3Service().deleteByGuid(guid);
    }
    ...
    public int update(SpglZjfwsxblgcxxbV3 record) {
        return new SpglZjfwsxblgcxxbV3Service().update(record);
    }
    ...
    public SpglZjfwsxblgcxxbV3 find(Object primaryKey) {
        return new SpglZjfwsxblgcxxbV3Service().find(primaryKey);
    }
    ...
    public SpglZjfwsxblgcxxbV3 find(String sql, Object... args) {
        return new SpglZjfwsxblgcxxbV3Service().find(sql, args);
    }
    ...
    public List<SpglZjfwsxblgcxxbV3> findList(String sql, Object... args) {
        return new SpglZjfwsxblgcxxbV3Service().findList(sql, args);
    }
    ...
    public List<SpglZjfwsxblgcxxbV3> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return new SpglZjfwsxblgcxxbV3Service().findList(sql, pageNumber, pageSize, args);
    }
    ...
    public Integer countSpglZjfwsxblgcxxbV3(String sql, Object... args) {
        return new SpglZjfwsxblgcxxbV3Service().countSpglZjfwsxblgcxxbV3(sql, args);
    }
