...
@Component
@Service
public class SpglJsgcjgysbaxxbV3ServiceImpl implements ISpglJsgcjgysbaxxbV3Service {
    /**
     * 插入数据
     *
    ...
    public int insert(SpglJsgcjgysbaxxbV3 record) {
        return new SpglJsgcjgysbaxxbV3Service().insert(record);
    }
    ...
    public int deleteByGuid(String guid) {
        return new SpglJsgcjgysbaxxbV3Service().deleteByGuid(guid);
    }
    ...
    public int update(SpglJsgcjgysbaxxbV3 record) {
        return new SpglJsgcjgysbaxxbV3Service().update(record);
    }
    ...
    public SpglJsgcjgysbaxxbV3 find(Object primaryKey) {
        return new SpglJsgcjgysbaxxbV3Service().find(primaryKey);
    }
    ...
    public SpglJsgcjgysbaxxbV3 find(String sql, Object... args) {
        return new SpglJsgcjgysbaxxbV3Service().find(sql, args);
    }
    ...
    public List<SpglJsgcjgysbaxxbV3> findList(String sql, Object... args) {
        return new SpglJsgcjgysbaxxbV3Service().findList(sql, args);
    }
    ...
    public List<SpglJsgcjgysbaxxbV3> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return new SpglJsgcjgysbaxxbV3Service().findList(sql, pageNumber, pageSize, args);
    }
    ...
    public Integer countSpglJsgcjgysbaxxbV3(String sql, Object... args) {
        return new SpglJsgcjgysbaxxbV3Service().countSpglJsgcjgysbaxxbV3(sql, args);
    }
     ...
     */
    @Override
    public int updateNoValidate(SpglJsgcjgysbaxxbV3 record) {
        return new SpglJsgcjgysbaxxbV3Service().update(record);
    }
     ...
     */
    @Override
    public int insertNoValidate(SpglJsgcjgysbaxxbV3 record) {
        return new SpglJsgcjgysbaxxbV3Service().insert(record);
    }
