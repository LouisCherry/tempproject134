 ...
 */
@Entity(table = "SPGL_DFXMSPLCJDXXB", id = "rowguid")
public class SpglDfxmsplcjdxxb extends BaseEntity implements Cloneable
{
    ...
    */
     ...
     * 里程碑事项类型
     */
    public Integer getLcbsxlx() {
        return super.getInt("lcbsxlx");
    }
    
    public void setLcbsxlx(Integer lcbsxlx) {
        super.set("lcbsxlx", lcbsxlx);
    }
