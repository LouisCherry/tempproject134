...
public class SpglJsydghxkxxbV3 extends BaseEntity implements Cloneable {
    ...
    public String getPzydwh() {
        return super.get("pzydwh");
    }

    public void setPzydwh(String pzydwh) {
        super.set("pzydwh", pzydwh);
    }
     ...
     * 批准用地机关
     */
    public String getPzydjg() {
        return super.get("pzydjg");
    }

    public void setPzydjg(String pzydjg) {
        super.set("pzydjg", pzydjg);
    }
     ...
     * 用地单位统一社会信用代码
     */
    public String getYdtyshxydm() {
        return super.get("ydtyshxydm");
    }

    public void setYdtyshxydm(String ydtyshxydm) {
        super.set("ydtyshxydm", ydtyshxydm);
    }
