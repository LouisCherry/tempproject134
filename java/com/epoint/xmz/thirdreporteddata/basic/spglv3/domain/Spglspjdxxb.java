 ...
 * @作者 zhpengsy
 */
@Entity(table = "SPGL_SPJDXXB_V3", id = "rowguid")
public class Spglspjdxxb extends BaseEntity implements Cloneable {
     ...
     * 阶段办事指南地址
     */
    public String getJdbszndz() {
        return super.get("jdbszndz");
    }

    public void setJdbszndz(String jdbszndz) {
        super.set("jdbszndz", jdbszndz);
    }

    /**
     * 阶段并联申报地址
     */
    public String getJdblsbdz() {
        return super.get("jdblsbdz");
    }

    public void setJdblsbdz(String jdblsbdz) {
        super.set("jdblsbdz", jdblsbdz);
    }
