 ...
 * 项目前期意见信息表实体
 *
 * @version [版本号, 2019-07-02 16:08:20]
 */
@Entity(table = "SPGL_XMQQYJXXB_V3", id = "rowguid")
public class SpglXmqqyjxxbV3 extends BaseEntity implements Cloneable {
