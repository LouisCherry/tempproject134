...
public class SpglJsgcxfsjscxxbV3 extends BaseEntity implements Cloneable {
     ...
     * 建设工程规划许可日期
     */
    public Date getGcghxkrq() {
        return super.getDate("gcghxkrq");
    }

    public void setGcghxkrq(Date gcghxkrq) {
        super.set("gcghxkrq", gcghxkrq);
    }

    /**
     * 临时性建筑批准文件（依法需要办理的）
     */
    public String getLsxjzpzwj() {
        return super.get("lsxjzpzwj");
    }

    public void setLsxjzpzwj(String lsxjzpzwj) {
        super.set("lsxjzpzwj", lsxjzpzwj);
    }

    /**
     * 临时性建筑批准日期（依法需要办理的）
     */
    public Date getLsxjzpzrq() {
        return super.getDate("lsxjzpzrq");
    }

    public void setLsxjzpzrq(Date lsxjzpzrq) {
        super.set("lsxjzpzrq", lsxjzpzrq);
    }
     ...
     */
    public Integer getSfjqxxf() {
        return super.getInt("sfjqxxf");
    }

    public void setSfjqxxf(Integer sfjqxxf) {
        super.set("sfjqxxf", sfjqxxf);
    }
     ...
     * 消防设施及其他
     */
    public String getXfcsjqt() {
        return super.get("xfcsjqt");
    }

    public void setXfcsjqt(String xfcsjqt) {
        super.set("xfcsjqt", xfcsjqt);
    }

    /**
     * 工程简要说明
     */
    public String getGcjysm() {
        return super.get("gcjysm");
    }

    public void setGcjysm(String gcjysm) {
        super.set("gcjysm", gcjysm);
    }
