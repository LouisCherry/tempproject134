...
public class SpglJsgcghxkxxbV3 extends BaseEntity implements Cloneable {
     ...
     * 附图及附件名称
     */
    public String getFtjfjmc() {
        return super.get("ftjfjmc");
    }

    public void setFtjfjmc(String ftjfjmc) {
        super.set("ftjfjmc", ftjfjmc);
    }

    /**
     * 项目总平面图
     */
    public String getXmzpmt() {
        return super.get("xmzpmt");
    }

    public void setXmzpmt(String xmzpmt) {
        super.set("xmzpmt", xmzpmt);
    }
