 ...
 * 项目审批事项征求意见信息表实体
 *
 * @version [版本号, 2019-07-02 16:08:36]
 * @作者 Administrator
 */
@Entity(table = "SPGL_XMSPSXZQYJXXB_V3", id = "rowguid")
public class SpglXmspsxzqyjxxbV3 extends BaseEntity implements Cloneable {
