...
public class SpglsplcjdsxxxbService {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(Spglsplcjdsxxxb.class, guid);
    ...
    public Spglsplcjdsxxxb find(Object primaryKey) {
        return baseDao.find(Spglsplcjdsxxxb.class, primaryKey);
    }
    ...
    public Spglsplcjdsxxxb find(String sql, Object... args) {
        return baseDao.find(sql, Spglsplcjdsxxxb.class, args);
    }
    ...
    public List<Spglsplcjdsxxxb> findList(String sql, Object... args) {
        return baseDao.findList(sql, Spglsplcjdsxxxb.class, args);
    }
    ...
    public List<Spglsplcjdsxxxb> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, Spglsplcjdsxxxb.class, args);
    }

    public void deleteBySpGuid(String guid) {
        Entity en = Spglsplcjdsxxxb.class.getAnnotation(Entity.class);
     ...
     * @return
     */
    public List<Spglsplcjdsxxxb> getAllRecord(Class<? extends BaseEntity> baseClass, Map<String, String> conditionMap) {
    ...
    public Integer getAllRecordCount(Class<? extends BaseEntity> baseClass, Map<String, String> conditionMap) {
        List<Spglsplcjdsxxxb> result = getAllRecord(baseClass, conditionMap);
        if (result != null) {
            return result.size();
        } else {
            return 0;
     ...
     * @return
     */
    public PageData<Spglsplcjdsxxxb> getAllRecordByPage(Class<? extends BaseEntity> baseClass,
    ...
    public Spglsplcjdsxxxb getSpglsplcjdsxxxb(Double splcbbh, String splcbm, Double spsxbbh, String spsxbm) {
        ...
        return baseDao.find(sql, Spglsplcjdsxxxb.class, splcbbh, splcbm, spsxbbh, spsxbm);

    }

    public List<Spglsplcjdsxxxb> getNeedAddNewVersionByItemId(String item_id) {
        ...
        return baseDao.findList(sql, Spglsplcjdsxxxb.class, item_id, item_id);
    }
