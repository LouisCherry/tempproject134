...
/**
 * 中介服务事项办理过程信息表对应的后台service
 *
 * @author Epoint
 * @version [版本号, 2023-09-25 15:23:49]
 */
public class SpglZjfwsxblgcxxbV3Service {
    /**
     * 数据增删改查组件
     */
    protected ICommonDao baseDao;

    public SpglZjfwsxblgcxxbV3Service() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(SpglZjfwsxblgcxxbV3.class, guid);
    ...
    public SpglZjfwsxblgcxxbV3 find(Object primaryKey) {
        return baseDao.find(SpglZjfwsxblgcxxbV3.class, primaryKey);
    }
    ...
    public SpglZjfwsxblgcxxbV3 find(String sql, Object... args) {
        return baseDao.find(sql, SpglZjfwsxblgcxxbV3.class, args);
    }
    ...
    public List<SpglZjfwsxblgcxxbV3> findList(String sql, Object... args) {
        return baseDao.findList(sql, SpglZjfwsxblgcxxbV3.class, args);
    }
    ...
    public List<SpglZjfwsxblgcxxbV3> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, SpglZjfwsxblgcxxbV3.class, args);
    }
