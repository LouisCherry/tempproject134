...
/**
 * 地方规划控制线信息表对应的后台service
 *
 * @author Epoint
 * @version [版本号, 2023-09-25 15:35:51]
 */
public class SpglDfghkzxxxbV3Service {
    /**
     * 数据增删改查组件
     */
    protected ICommonDao baseDao;

    public SpglDfghkzxxxbV3Service() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(SpglDfghkzxxxbV3.class, guid);
    ...
    public SpglDfghkzxxxbV3 find(Object primaryKey) {
        return baseDao.find(SpglDfghkzxxxbV3.class, primaryKey);
    }
    ...
    public SpglDfghkzxxxbV3 find(String sql, Object... args) {
        return baseDao.find(sql, SpglDfghkzxxxbV3.class, args);
    }
    ...
    public List<SpglDfghkzxxxbV3> findList(String sql, Object... args) {
        return baseDao.findList(sql, SpglDfghkzxxxbV3.class, args);
    }
    ...
    public List<SpglDfghkzxxxbV3> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, SpglDfghkzxxxbV3.class, args);
    }
