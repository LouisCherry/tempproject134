 ...
 */
public class SpglZrztxxbV3Service {
    /**
     * 数据增删改查组件
     */
    protected ICommonDao baseDao;

    public SpglZrztxxbV3Service() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(SpglZrztxxbV3.class, guid);
    ...
    public SpglZrztxxbV3 find(Object primaryKey) {
        return baseDao.find(SpglZrztxxbV3.class, primaryKey);
    }
    ...
    public SpglZrztxxbV3 find(String sql, Object... args) {
        return baseDao.find(sql, SpglZrztxxbV3.class, args);
    }
    ...
    public List<SpglZrztxxbV3> findList(String sql, Object... args) {
        return baseDao.findList(sql, SpglZrztxxbV3.class, args);
    }
    ...
    public List<SpglZrztxxbV3> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, SpglZrztxxbV3.class, args);
    }
    ...
    public List<Record> getAddedDwInfo(String xzqhdm, String gcdm) {
        String sql = "select DISTINCT dwtyshxydm,dwlx from SPGL_ZRZTXXB_V3 where xzqhdm = ? and gcdm = ? and sjyxbs = 1";
        return baseDao.findList(sql, Record.class, xzqhdm, gcdm);
    }
     ...
     * @see [类、类#方法、类#成员]
     */
    public PageData<SpglZrztxxbV3> getAllRecordByPage(Class<? extends BaseEntity> baseClass,
    ...
    public List<SpglZrztxxbV3> getAllRecord(Class<? extends BaseEntity> baseClass,
                                            Map<String, String> conditionMap) {
        SQLManageUtil sqlManageUtil = new SQLManageUtil(baseClass);
        return sqlManageUtil.getListByCondition(baseClass, conditionMap);
    }

    public List<ParticipantsInfo> getParticipantsInfoListBySubappguid(String subappguid) {
        String sql = "select * from participants_info where subappguid = ? and corptype in ('1','2','3','4')";
        return baseDao.findList(sql, ParticipantsInfo.class, subappguid);
    }
