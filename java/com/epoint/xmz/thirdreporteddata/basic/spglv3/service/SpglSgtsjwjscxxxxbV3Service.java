...
/**
 * 施工图设计文件审查详细信息表对应的后台service
 *
 * @author Epoint
 * @version [版本号, 2023-09-25 11:41:04]
 */
public class SpglSgtsjwjscxxxxbV3Service {
    /**
     * 数据增删改查组件
     */
    protected ICommonDao baseDao;

    public SpglSgtsjwjscxxxxbV3Service() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(SpglSgtsjwjscxxxxbV3.class, guid);
    ...
    public SpglSgtsjwjscxxxxbV3 find(Object primaryKey) {
        return baseDao.find(SpglSgtsjwjscxxxxbV3.class, primaryKey);
    }
    ...
    public SpglSgtsjwjscxxxxbV3 find(String sql, Object... args) {
        return baseDao.find(sql, SpglSgtsjwjscxxxxbV3.class, args);
    }
    ...
    public List<SpglSgtsjwjscxxxxbV3> findList(String sql, Object... args) {
        return baseDao.findList(sql, SpglSgtsjwjscxxxxbV3.class, args);
    }
    ...
    public List<SpglSgtsjwjscxxxxbV3> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, SpglSgtsjwjscxxxxbV3.class, args);
    }
    ...
    public PageData<SpglSgtsjwjscxxxxbV3> getitemByPage(Map<String, String> conditionMap, int firstResult,
                                                        int maxResults, String sortField, String sortOrder) {
        return new SQLManageUtil().getDbListByPage(SpglSgtsjwjscxxxxbV3.class, conditionMap, firstResult, maxResults, sortField,
                sortOrder);
    }
}
