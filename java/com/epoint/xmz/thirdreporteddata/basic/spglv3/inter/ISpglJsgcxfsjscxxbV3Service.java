...
/**
 * 建设工程消防设计审查信息表对应的后台service接口
 *
 * @author Epoint
 * @version [版本号, 2023-09-25 14:00:20]
 */
public interface ISpglJsgcxfsjscxxbV3Service extends Serializable {
     ...
     * @see [类、类#方法、类#成员]
     */
    public int updateNoValidate(SpglJsgcxfsjscxxbV3 dataBean);
     ...
     * @see [类、类#方法、类#成员]
     */
    public int insertNoValidate(SpglJsgcxfsjscxxbV3 dataBean);

    int getSpglJsgcxfsjscxxbV3ByFlowsn(String flowsn);
