...
/**
 * 责任主体信息表对应的后台service接口
 *
 * @author Epoint
 * @version [版本号, 2023-09-25 17:01:40]
 */
public interface ISpglZrztxxbV3Service extends Serializable {
    ...
    List<ParticipantsInfo> getParticipantsInfoListBySubappguid(String subappguid);
