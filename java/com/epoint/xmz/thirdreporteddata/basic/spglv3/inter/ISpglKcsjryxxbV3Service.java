...
/**
 * 勘察设计人员信息表对应的后台service接口
 *
 * @author Epoint
 * @version [版本号, 2023-09-25 11:21:13]
 */
public interface ISpglKcsjryxxbV3Service extends Serializable {
    ...
    public AuditCommonResult<PageData<SpglKcsjryxxbV3>> getitemByPage(Map<String, String> map, int first,
