...
/**
 * 网厅访问量统计表对应的后台service
 * 
 * @author 1
 * @version [版本号, 2022-09-14 14:54:42]
 */
public class JnVisitRecordService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(JnVisitRecord.class, guid);
    ...
    public JnVisitRecord find(Object primaryKey) {
        return baseDao.find(JnVisitRecord.class, primaryKey);
    }
    ...
    public JnVisitRecord find(String sql,  Object... args) {
        return baseDao.find(sql, JnVisitRecord.class, args);
    }
    ...
    public List<JnVisitRecord> findList(String sql, Object... args) {
        return baseDao.findList(sql, JnVisitRecord.class, args);
    }
    ...
    public List<JnVisitRecord> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, JnVisitRecord.class, args);
    }
