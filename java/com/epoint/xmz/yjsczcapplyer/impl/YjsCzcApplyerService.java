...
/**
 * 一件事住租车申请人信息表对应的后台service
 * 
 * @author 1
 * @version [版本号, 2022-04-18 15:38:32]
 */
public class YjsCzcApplyerService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(YjsCzcApplyer.class, guid);
    ...
    public YjsCzcApplyer find(Object primaryKey) {
        return baseDao.find(YjsCzcApplyer.class, primaryKey);
    }
    ...
    public YjsCzcApplyer find(String sql,  Object... args) {
        return baseDao.find(sql, YjsCzcApplyer.class, args);
    }
    ...
    public List<YjsCzcApplyer> findList(String sql, Object... args) {
        return baseDao.findList(sql, YjsCzcApplyer.class, args);
    }
    ...
    public List<YjsCzcApplyer> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, YjsCzcApplyer.class, args);
    }
