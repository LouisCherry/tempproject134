 ...
 */
public class AuditTaskJnRenlingService
{
    /**
     * 数据增删改查组件
     */
    ...
    public AuditTaskJnRenlingService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditTaskJnRenling.class, guid);
    ...
    public AuditTaskJnRenling find(Object primaryKey) {
        return baseDao.find(AuditTaskJnRenling.class, primaryKey);
    }
    ...
    public AuditTaskJnRenling find(String sql, Object... args) {
        return baseDao.find(sql, AuditTaskJnRenling.class, args);
    }
    ...
    public List<AuditTaskJnRenling> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditTaskJnRenling.class, args);
    }
    ...
    public List<AuditTaskJnRenling> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditTaskJnRenling.class, args);
    }
