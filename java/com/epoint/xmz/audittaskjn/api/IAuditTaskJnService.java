package com.epoint.xmz.audittaskjn.api;
...
/**
 * 事项个性化表对应的后台service接口
 *
 * @author Administrator
 * @version [版本号, 2023-11-01 14:01:22]
 */
public interface IAuditTaskJnService extends Serializable {
     ...
     * 获取所有部门
     */
    List<FrameOu> getAllOu();

    void deleteAllTaskJnByTaskid(String task_id);
