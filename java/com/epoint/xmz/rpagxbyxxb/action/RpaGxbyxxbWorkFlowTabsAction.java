 ...
 */
@RestController("rpagxbyxxbworkflowtabsaction")
@Scope("request")
public class RpaGxbyxxbWorkFlowTabsAction extends WorkflowBaseController
{
    ...
    // 数据表名
    private String sqlTableName = "rpa_gxbyxxb";
