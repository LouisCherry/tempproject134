package com.epoint.xmz.auditspyyyzmaterial.api.entity;
...
public class AuditSpYyyzMaterial extends BaseEntity implements Cloneable
{
    ...
    */
     ...
     * 是否是一链办理材料
     */
     public int getIsylbl() {
         return super.get("isylbl");
     }

     public void setIsylbl(int isylbl) {
         super.set("isylbl", isylbl);
     }
}
