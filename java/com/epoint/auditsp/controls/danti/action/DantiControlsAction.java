package com.epoint.auditsp.controls.danti.action;
 ...
 */
@RestController("danticontrolsaction")
@Scope("request")
public class DantiControlsAction extends BaseController {
...
//        if (StringUtil.isBlank(dataBean)) {
        dantiinfolist = dantiInfoService.findListByProjectguid(itemguidtemp);
//        }
//        else {
//            dantiinfolist = dantiInfoService.findListByProjectguid(dataBean.getDlprojectguid());
//        }
        //建筑单体栋数
        //总建筑面积
        Double zjzmjz = 0.0;
