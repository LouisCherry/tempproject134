 ...
 */
@RestController("handlebipreliminarydetailaction")
@Scope("request")
public class HandleBiPreliminarydetailAction extends BaseController
{
    /**
     * 
     */
    ...
    public void pageLoad() {
        ...
        if (spInstance != null) {
            ...
            zitem = rsItemBaseinfoService.getAuditRsItemBaseinfoByRowguid(auditSpISubapp.getYewuguid()).getResult();
    ...
    public void passyes() {
        ...
        if(StringUtil.isNotBlank(messageguid)){
            //判断消息是否处理过
            MessagesCenter message =  messageCenterService.getDetail(messageguid, UserSession.getInstance().getUserGuid());
            if(message == null){
            ...
            if (CollectionUtils.isNotEmpty(taskList) && StringUtil.isBlank(ConfigUtil.getFrameConfigValue("generateTxProject"))) {
                ...
                String projectGuid = handleProjectService
                        .InitBLSPProject(auditTask.getRowguid(), "", userSession.getDisplayName(), userSession.getUserGuid(),
                                dataBean.getItemlegalcerttype(), dataBean.getItemlegalcertnum(), "", "", ZwfwUserSession.getInstance().getCenterGuid(), biGuid,
            ...
            if (ous != null && ous.length > 0 && StringUtil.isNotBlank(ous[0])) {
                ...
                for (String taskid : lists) {
                    ...
                    auditSpITaskService.addTaskInstance(businessGuid, biGuid, phaseguid, auditTask.getRowguid(),
                            ...
                            auditTask.getOrdernum() == null ? 0 : auditTask.getOrdernum(), auditTask.getAreacode(),basetask.getSflcbsx());
                }
        ...
        if(StringUtil.isNotBlank(zitem.getParentid())){
            AuditRsItemBaseinfo dataBean1 = rsItemBaseinfoService.getAuditRsItemBaseinfoByRowguid(zitem.getParentid()).getResult();
            if(dataBean1 != null){
       ...
       if(auditSpISubapp != null && StringUtil.isBlank(username)) {
           String openUrl = configService.getFrameConfigValue("zwdtMsgurl")+"/epointzwmhwz/pages/approve/perioddetailW?biguid="+auditSpISubapp.getBiguid()
            ...
            taskListModel = new DataGridModel<Record>()
            {
                ...
                public List<Record> fetchData(int arg0, int arg1, String arg2, String arg3) {
                    ...
                    for (AuditSpTask sptask : listsptask) {
                        if (StringUtil.isNotBlank(sptask.getBasetaskguid() )) {
            ...
            model = new DataGridModel<Record>()
            {
                ...
                public List<Record> fetchData(int arg0, int arg1, String arg2, String arg3) {
                    ...
                    for (AuditSpTask auditsptask : listsptask) {
                        if (!basetaskguids.contains(auditsptask.getBasetaskguid()) && auditsptask.getBasetaskguid() != null) {
