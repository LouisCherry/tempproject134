 ...
 *
 */
@RestController("adminhandlebilistviewaction")
@Scope("request")
public class AdminHandleBiListViewAction extends BaseController
{
    /**
     * 
     */
            ...
            model = new DataGridModel<AuditSpInstance>()
            {
                ...
                public List<AuditSpInstance> fetchData(int first, int pageSize, String sortField, String sortOrder) {
                    ...
                    List<AuditSpInstance> pageData = iJnAuditSpInstance
                            .getAuditSpInstanceByPage(first, pageSize, applyername, itemname);
                    ...
                    this.setRowCount(iJnAuditSpInstance.getAuditSpInstanceCount(applyername, itemname));
