 ...
 */
public class AuditSpJointitemService
{
    /**
     * 数据增删改查组件
     */
    ...
    public AuditSpJointitemService() {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(AuditSpJointitem.class, guid);
    ...
    public AuditSpJointitem find(Object primaryKey) {
        return baseDao.find(AuditSpJointitem.class, primaryKey);
    }
    ...
    public AuditSpJointitem find(String sql, Object... args) {
        return baseDao.find(sql, AuditSpJointitem.class, args);
    }
    ...
    public List<AuditSpJointitem> findList(String sql, Object... args) {
        return baseDao.findList(sql, AuditSpJointitem.class, args);
    }
    ...
    public List<AuditSpJointitem> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, AuditSpJointitem.class, args);
    }
