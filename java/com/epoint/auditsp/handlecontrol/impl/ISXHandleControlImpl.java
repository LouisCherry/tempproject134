package com.epoint.auditsp.handlecontrol.impl;
...
import com.epoint.auditsp.handlecontrol.inter.ISXHandleControl;
...
@Component
@Service
public class ISXHandleControlImpl implements ISXHandleControl
{
    @Override
    ...
    public HashMap<String, HashMap> initHandleControls(AuditProject auditProject, String taskGuid, String workItemGuid,
        ...
        IAuditLogisticsBasicInfo iAuditLogisticsBasicInfo = ContainerFactory.getContainInfo().getComponent(IAuditLogisticsBasicInfo.class);
        /**
         * 右侧办件状态信息
         */
        ...
        if (audittask != null) {
            ...
            btnMap.put("btnTuihui", ZwfwConstant.CONSTANT_STR_ZERO);
            ...
            // 2、办件已经创建
                        ...
                        case ZwfwConstant.LHSP_RESULTTYPE_ZZ:// 证照
                            ...
                            if (StringUtil.isNotBlank(auditresult.getSharematerialguid())) {
                                ...
                                CertCatalog certCatalog = iCertConfigExternal.getCatalogByCatalogid(
                                        auditresult.getSharematerialguid().split(",")[0], auditProject.getAreacode());
                                // 共享材料存在且处理地址为空
                ...
                String ifexpress_ma = StringUtil.isBlank(auditProject.getIf_express_ma())
                        ? ZwfwConstant.CONSTANT_STR_ZERO : auditProject.getIf_express_ma();// 办件是否使用申报材料呼叫快递
                ...
                // 2.3.2已受理未办结时，正常计时或暂停计时
                    ...
                    if (isbanjiestep != ZwfwConstant.CONSTANT_INT_ONE) {
                        //个性化退回
                        btnMap.replace("btnTuihui", ZwfwConstant.CONSTANT_STR_ONE);
    ...
    /*@SuppressWarnings({"rawtypes", "unchecked" })
    @Override
    public HashMap<String, HashMap> initHandleControls(AuditProject auditProject, String isJSTY, String callmode,
    		String taskGuid, String workItemGuid, String centerGuid, String areaCode, String userGuid,
    		String windowguid) {
    			return null;
