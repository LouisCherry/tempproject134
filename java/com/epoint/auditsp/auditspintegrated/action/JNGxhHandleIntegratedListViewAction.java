 ...
 *
 */
@RestController("jngxhhandleintegratedlistviewaction")
@Scope("request")
public class JNGxhHandleIntegratedListViewAction extends BaseController
{
    /**
     * 
     */
        ...
        if (model == null) {
            model = new DataGridModel<AuditSpInstance>()
            {
                ...
                public List<AuditSpInstance> fetchData(int first, int pageSize, String sortField, String sortOrder) {
                    ...
                    sql.in("b.businessguid", "'f6d11064-aa7a-4b50-9b1e-ed1b971abec4','cc5bd480-0197-4c62-a9b8-391b88d2e1b3'");
                    ...
                    for (AuditSpInstance instance : list) {
                    	if (StringUtil.isBlank(instance.getStr("hasyjs"))) {
                    		instance.set("hasyjs", "0");
                    	}
                    }
