...
public class FloatWindowService {
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(FloatWindow.class, guid);
    ...
    public FloatWindow find(Object primaryKey) {
        return baseDao.find(FloatWindow.class, primaryKey);
    }
    ...
    public FloatWindow find(String sql, Object... args) {
        return baseDao.find(sql, FloatWindow.class, args);
    }
    ...
    public List<FloatWindow> findList(String sql, Object... args) {
        return baseDao.findList(sql, FloatWindow.class, args);
    }
    ...
    public List<FloatWindow> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, FloatWindow.class, args);
    }
