 ...
 */
@RestController("jnaudittasktjlistaction")
@Scope("request")
public class JNAuditTaskTjListAction extends BaseController
{
    ...
    public void judgeIfCopy(String taskGuid, String operation) {
        ...
        if (auditTaskDSH != null) {
            ...
            AuditTask copyAuditTask = auditTaskBasicImpl
                    ...
                    .getResult();
            if (copyAuditTask != null && (copyAuditTask.getIs_history() == null
                    || copyAuditTask.getIs_history() != ZwfwConstant.CONSTANT_INT_ONE)) {
