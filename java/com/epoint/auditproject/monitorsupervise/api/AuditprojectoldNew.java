...
* 
* @作者 张彬彬 
* @version [版本号, 2022-03-12 19:11:20] 
*/

@Entity(table = "audit_project_old_new", id = "rowguid")
public class AuditprojectoldNew extends BaseEntity {
	...
	* 获取
	*/
	public String getNewsync() { 
 		return super.getStr("newsync");
 	}
	/**
	* 设置
	*/
	public void setNewsync(String newsync) { 
 		super.set("newsync", newsync);
 	}
	/**
	* 获取
	*/
	...
	* 获取
	*/
	public String getIs_rpa() { 
 		return super.getStr("is_rpa");
 	}
	/**
	* 设置
	*/
	public void setIs_rpa(String is_rpa) { 
 		super.set("is_rpa", is_rpa);
 	}
	/**
	* 获取
	*/
	public String getIs_msg() { 
 		return super.getStr("is_msg");
 	}
	/**
	* 设置
	*/
	public void setIs_msg(String is_msg) { 
 		super.set("is_msg", is_msg);
 	}
}