 ...
 */
@RestController("jnwindowauditbanjianlistaction")
@Scope("request")
public class JnWindowAuditBanJianListAction extends BaseController
{
            ...
            model = new DataGridModel<AuditProject>()
            {
                ...
                public List<AuditProject> fetchData(int first, int pageSize, String sortField, String sortOrder) {
                    ...
                    if (taskidList != null && !taskidList.isEmpty()) {
                        ...
                        String fields = "rowguid,taskguid,projectname,applyeruserguid,applyername,areacode,pviguid,status,tasktype,flowsn,applydate,OperateUserName,contactmobile,contactcertnum,certnum ";
                        if(like){
                            //区分大小写查询
    ...
    public ExportModel getExportModel() {
        if (exportModel == null) {
            exportModel = new ExportModel(
                    "projectname,flowsn,applyername,applydate,contactmobile,contactcertnum,certnum,operateUserName",
                    "事项名称,办件编号,申请人,申请时间,联系电话,联系人身份证号/法人身份证号,办理人身份证/企业统一信用代码,审核人员名称");
        }
        return exportModel;
    }
