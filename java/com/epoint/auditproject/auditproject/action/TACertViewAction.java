 ...
 */
@RestController("tacertviewaction")
@Scope("request")
public class TACertViewAction extends BaseController {
    /**
     *
     */
...
//        log.info("jstattachguid:"+getRequestParameter("jstattachguid"));
        ...
        if (StringUtil.isBlank(cert_identifier)) {
    ...
    public String getQRcodePicinfo() {
        ...
        try {
            ...
            log.info("getpdfresult:"+getpdfresult);
            //记录调用证照的调用次数
            ...
            log.info("status:"+getpdfheadjson.getString("status"));
