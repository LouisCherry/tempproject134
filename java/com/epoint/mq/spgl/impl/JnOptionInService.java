 ...
 */
public class JnOptionInService
{
 /**
     * 数据增删改查组件
     */
    ...
    public <T extends Record> int deleteByGuid(String guid) {
        T t = baseDao.find(JnOptionIn.class, guid);
    ...
    public JnOptionIn find(Object primaryKey) {
        return baseDao.find(JnOptionIn.class, primaryKey);
    }
    ...
    public JnOptionIn find(String sql,  Object... args) {
        return baseDao.find(sql, JnOptionIn.class, args);
    }
    ...
    public List<JnOptionIn> findList(String sql, Object... args) {
        return baseDao.findList(sql, JnOptionIn.class, args);
    }
    ...
    public List<JnOptionIn> findList(String sql, int pageNumber, int pageSize, Object... args) {
        return baseDao.findList(sql, pageNumber, pageSize, JnOptionIn.class, args);
    }
    ...
    public List<JnOptionIn> getJnOptionInByXmdm(String xmdm) {
    	String sql = "select * from spgl_xmqqyjxxb where xmdm = ?";
        return baseDao.findList(sql, JnOptionIn.class, xmdm);
    }
}
