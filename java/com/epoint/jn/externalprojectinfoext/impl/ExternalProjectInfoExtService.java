package com.epoint.jn.externalprojectinfoext.impl;
...
public class ExternalProjectInfoExtService
{
    ...
    public List<Record> finList(int first, int pagesize, String ouguid, String areacode,int month) {
        String sql = "select * from external_project_info_ext_"+month+" where 1=1 and is_lczj = '9' ";
    ...
    public Integer finTotal(String ouguid, String areacode) {
        String sql = "select count(1) from external_project_info_ext where is_lczj = '9' ";
        if (StringUtil.isNotBlank(ouguid)) {
            sql += " and accept_ou_guid = '" + ouguid + "' ";
        }
        if (StringUtil.isNotBlank(areacode)) {
    ...
    public List<Record> finList(int first, int pagesize, String ouguid, String areacode,String projectno) {
        String sql = "select * from external_project_info_ext where 1=1 ";
        if (StringUtil.isNotBlank(ouguid)) {
            sql += " and accept_ou_guid = '" + ouguid + "' ";
        }
        if (StringUtil.isNotBlank(areacode)) {
