...
@RestController("jnwebuploaderdaorufouraction")
@Scope("request")
public class JNWebUploaderDaorufouraction extends BaseController {
    ...
    private Logger logger = Logger.getLogger(JNWebUploaderDaorufouraction.class);
            ...
            dataImportModel = new DataImportModel9(new ImportExcelHandler() {
                ...
                public String saveExcelData(String filename, String sheetName, int sheet, int curRow, int totalRows,
                    ...
                    try {
                        ...
                        lcprojectfour project = new lcprojectfour();
