...
@RestController("jnwebuploaderdaoruthreeaction")
@Scope("request")
public class JNWebUploaderDaoruthreeaction extends BaseController {
    ...
    private Logger logger = Logger.getLogger(JNWebUploaderDaoruthreeaction.class);
            ...
            dataImportModel = new DataImportModel9(new ImportExcelHandler() {
                ...
                public String saveExcelData(String filename, String sheetName, int sheet, int curRow, int totalRows,
                    ...
                    try {
                        ...
                        lcprojectthree project = new lcprojectthree();
