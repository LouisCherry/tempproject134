...
@RestController("jnwebuploaderdaorusixaction")
@Scope("request")
public class JNWebUploaderDaoruaction6 extends BaseController
{
            ...
            dataImportModel = new DataImportModel9(new ImportExcelHandler()
            {
                ...
                public String saveExcelData(String filename, String sheetName, int sheet, int curRow, int totalRows,
                    ...
                    try {
                        ...
                        lcprojectsix project = new lcprojectsix();
                        ...
                        if (sheet == 0) {
                            ...
                            if (curRow > 1) {
                                                ...
                                                if (StringUtil.isNotBlank(unid)) {
                                                    ...
                                                    try {
                                                        ...
                                                        if (jsonObj != null && "200".equals(jsonObj.getString("state"))) {
                                                            //logger.info("========================>获取受理编码成功！" + jsonObj.getString("receiveNum") + "#####"+ jsonObj.getString("password"));
                                                        ...
                                                        logger.info("接口请求报错！========================>" + e.getMessage());
                                                        e.printStackTrace();
                                                    }*/
                                                }
                                            }
                                ...
                                /*if(project != null ) {
                                	...
                                	String accepttime = EpointDateUtil.convertDate2String(project.getAcceptuserdate(), EpointDateUtil.DATE_FORMAT);
                                	...
                                	String banjietime = EpointDateUtil.convertDate2String(project.getBanjiedate(), "yyyy-MM-dd");
