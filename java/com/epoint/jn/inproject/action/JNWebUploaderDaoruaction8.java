...
@RestController("jnwebuploaderdaorueightaction")
@Scope("request")
public class JNWebUploaderDaoruaction8 extends BaseController {
    ...
    private Logger logger = Logger.getLogger(JNWebUploaderDaoruaction8.class);
            ...
            dataImportModel = new DataImportModel9(new ImportExcelHandler() {
                ...
                public String saveExcelData(String filename, String sheetName, int sheet, int curRow, int totalRows,
                    ...
                    try {
                        ...
                        lcprojecteight project = new lcprojecteight();
