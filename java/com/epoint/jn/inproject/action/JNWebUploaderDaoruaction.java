...
@RestController("jnwebuploaderdaoruaction")
@Scope("request")
public class JNWebUploaderDaoruaction extends BaseController {
    ...
    private Logger logger = Logger.getLogger(JNWebUploaderDaoruaction.class);
                        ...
                        if (sheet == 0) {
                            ...
                            if (curRow > 1) {
                                ...
                                for (int i = 0; i < data.length; i++) {
                                    ...
                                    switch (key) {
                                        ...
                                        case "所属区县":
                                            ...
                                            break;
                                        case "事项名称": task = service.getAuditTaskByTaskname(value, areacode, ouguid);
                                            taskname = value;
                                ...
                                if (project != null) {
                                    ...
                                    FrameOu frameOu = service.getFrameOuByOunameNew(project.getOuname(), nowareacode);
