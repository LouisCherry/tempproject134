...
@RestController("jnwebuploaderdaorusevenaction")
@Scope("request")
public class JNWebUploaderDaoruaction7 extends BaseController {
    ...
    private Logger logger = Logger.getLogger(JNWebUploaderDaoruaction7.class);
            ...
            dataImportModel = new DataImportModel9(new ImportExcelHandler() {
                ...
                public String saveExcelData(String filename, String sheetName, int sheet, int curRow, int totalRows,
                    ...
                    try {
                        ...
                        lcprojectseven project = new lcprojectseven();
