...
@RestController("jnwebuploaderdaorutenaction")
@Scope("request")
public class JNWebUploaderDaoruaction10 extends BaseController {
    ...
    private Logger logger = Logger.getLogger(JNWebUploaderDaoruaction10.class);
            ...
            dataImportModel = new DataImportModel9(new ImportExcelHandler() {
                ...
                public String saveExcelData(String filename, String sheetName, int sheet, int curRow, int totalRows,
                    ...
                    try {
                        ...
                        lcprojectten project = new lcprojectten();
                            ...
                            if (curRow > 1) {
                                ...
                                for (int i = 0; i < data.length; i++) {
                                    ...
                                    switch (key) {
                                        ...
                                        case "事项名称":
                                            logger.info(
                                                    "xlhvalue=" + value + "areacode" + areacode + "ouguid" + ouguid);
...
//                                                            log.info("========================>获取受理编码成功！" + result);
                                ...
                                if (project != null) {
                                    ...
                                    if (task != null && StringUtil.isNotBlank(task.getStr("inner_code"))) {
