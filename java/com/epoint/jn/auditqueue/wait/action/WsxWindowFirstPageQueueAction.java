...
@RestController("wsxwindowfirstpagequeueaction")
@Scope("request")
public class WsxWindowFirstPageQueueAction extends BaseController
{
        ...
        if (StringUtil.isNotBlank(MacAddress)) {
            ...
            if ("status=0".equals(url)) {
                ...
                if (StringUtil.isNotBlank(url)) {
                    redirect("jiningzwfw/individuation/370830000000/epointqueue/wait/" + url);
                }
                else {
